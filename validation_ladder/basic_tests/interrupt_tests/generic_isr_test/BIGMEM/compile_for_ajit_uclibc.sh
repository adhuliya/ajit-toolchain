...
SRCS=" -c ../main.c -c ../delay.c -s ../init.s -s $APT/asm/clear_stack_pointers.s -s $APT/asm/trap_handlers_for_rtos.s -s $APT/asm/generic_isr_mt.s -s $APT/asm/generic_sw_trap_mt.s -s $APT/asm/generic_sys_calls.s -C $APT/src -C $PT/src"
