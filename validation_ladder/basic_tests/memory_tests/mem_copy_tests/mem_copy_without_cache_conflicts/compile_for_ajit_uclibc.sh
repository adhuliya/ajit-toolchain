...
DATABASE=$2
VMAP=$3
MAIN=memcpy_no_cache_conflicts
...
$AJIT_FLASH_IMAGE_DIR/bin/mmapToAssyU64 memcpy_no_cache_conflicts.mmap memcpy_no_cache_conflicts_copy_asm.s $TEXTBASE 0x50000
...
compileToSparcUclibc.py -s $AJIT_FLASH_IMAGE_DIR/asm/bootstrap_u64.s -s memcpy_no_cache_conflicts_copy_asm.s -N bootstrap  -L bootstrapLinkerScript.lnk
