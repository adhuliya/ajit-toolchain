...
DEFS=" -D AJIT -D SWITCH -D NITERS=1024 -D NSIZE=9192 -D HAS_FLOAT -D NO_GLIBC" 
...
$AJIT_FLASH_IMAGE_DIR/bin/mmapToAssyU64 overhead.mmap.remapped overhead_copy_asm.s 0x40000000 0x50000
...
compileToSparcUclibc.py -s $AJIT_FLASH_IMAGE_DIR/asm/bootstrap_u64.s -s overhead_copy_asm.s -N bootstrap -L bootstrapLinkerScript.lnk
