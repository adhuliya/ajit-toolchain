...
DEFS=" -D NITERS=256 -D HAS_FLOAT -D AJIT"
#
...
$AJIT_FLASH_IMAGE_DIR/bin/mmapToAssyU64 memcopy_test.mmap memcopy_test_copy_asm.s 0x40000000 0x50000
...
compileToSparcUclibc.py -s $AJIT_FLASH_IMAGE_DIR/asm/bootstrap_u64.s -s memcopy_test_copy_asm.s -N bootstrap  -L bootstrapLinkerScript.lnk
