...
$AJIT_FLASH_IMAGE_DIR/bin/mmapToAssyU64 dcache_store_hit.mmap dcache_store_hit_copy_asm.s 0x40000000 0x50000
...
compileToSparcUclibc.py -s $AJIT_FLASH_IMAGE_DIR/asm/bootstrap_u64.s -s dcache_store_hit_copy_asm.s -N bootstrap  -L bootstrapLinkerScript.lnk
