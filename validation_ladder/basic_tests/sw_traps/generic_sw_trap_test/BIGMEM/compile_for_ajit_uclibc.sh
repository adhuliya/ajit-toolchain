...
SRCS=" -c ../main.c -s ../init.s -s $AAR/asm/clear_stack_pointers.s -s $AAR/asm/trap_handlers_for_rtos.s -s $AAR/asm/generic_sw_trap_mt.s -s $AAR/asm/generic_isr_mt.s -s $AAR/asm/generic_sys_calls.s  -C $AAR/src -C $PT/src"
