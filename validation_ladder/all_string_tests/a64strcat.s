...
checkz: 
	ldd [%i0], %l0 			!!check for destination address, at end of string
...
destuna:				!!!we have aligned source to dword now for other cases of dest
	...
	add %i0,8,%i0
	add %i1,8,%i1			!!! add as one doubleword loaded
	andcc %i0,3,%l4
...
wordal: 
	...
	add %i0,4,%i0
wrdlag:	
	slld %l0,0x20,%l6          	!!!shift to get lower word of previous doubleword into l6
	ldd [%i1],%l0
	addd %l2,%i0,%i0
