...
compileToSparcUclibc.py -U -g -V $VMAP -D USE_VMAP -N serial_interrupt_test\
			-s ../init.s -s $AAR/asm/trap_handlers_for_rtos.s -s $AAR/asm/generic_sw_trap_mt.s \
			-s $AAR/asm/generic_isr_single_stack_mt.s\
