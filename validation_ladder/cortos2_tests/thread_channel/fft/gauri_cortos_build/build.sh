...
compileToSparcUclibcv2.py \
  ...
  -D AJIT \
  -U \
   -D USE_CORTOS -F lm  -D USE_VMAP -C ./ -I $AJIT_HOME/application_development/thread_channel/include -C $AJIT_HOME/application_development/thread_channel/src ;
