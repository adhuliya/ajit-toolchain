...
uint8_t* lockStartAddr   = 0x40018000;
uint8_t* lockStartAddrNc = 0x40019000; // non-cacheable
...
void cortos_init_locks() {
  ...
  uint8_t* lockStartAddr   = (uint8_t*)0x40018000;
  uint8_t* lockStartAddrNc = (uint8_t*)0x40019000; // non-cacheable
