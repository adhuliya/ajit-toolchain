//add two numbers and display output

#include "sparc_stdio.h"

// Explicit function with ta 0 instruction
inline void ta0()
{
	__asm__ __volatile__("ta 0; nop; nop;");
}

// Make this always inline to initialize everything
void inline AJITinit() __attribute__((always_inline));
...
int  __attribute__((section(".text.main")))  main()
{
	...
	/* Actal code ends here! */
	
	ta0 ();
	return 0;
}

void inline AJITinit()
{
