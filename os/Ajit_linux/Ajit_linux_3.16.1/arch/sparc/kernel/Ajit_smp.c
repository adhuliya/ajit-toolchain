/*
 *  based on sun4m SMP support.
 *
 * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)
 * Copyright (C) 2023 Madhav P. Desai (madhav@ee.iitb.ac.in)
 */
...
// All IPI stuff mapped to IRQ 15.
#define IRQ_IPI_SINGLE		15
#define IRQ_IPI_MASK		15
#define IRQ_IPI_RESCHED		15
#define IRQ_CROSS_CALL		15

// TODO:
//   since all IPI IRQ's are mapped to 15, we need
//   a data structure to capture the kind of IPI
//   that is being signaled.  This is currently
//   possible using the 8-bytes of IPI message storage
//   in the AJIT interrupt controller.
//
...
void ajit_cpu_pre_online(void *arg)
{
