! Test for checking 'sdivcc instruction'
!
...
_start:
	...
	set 0x00000000,%g2			! Incremented if trap occurs
	...
	set 0x00000000,%l0 
	set 0x0000000A,%l1 
	sdivcc %l0,%l1,%l2			! Result is 0x00. Z is set 
	rd %psr, %i1 
	...
	set 0x0000014D,%l0 
	set 0xFFFFFF5B,%l1 
	sdivcc %l0,%l1,%l3			! Result is 0xFFFFFFFE. N is set
	rd %psr, %i2 

	! Check for Set V for positive result
	mov 0x00000052,%y
	set 0x7FFFFFFF,%l0 
	set 0x000000A5,%l1 
	sdivcc %l0,%l1,%l4			! Result is 0x7FFFFFFF. V is not set since result < 0x7FFFFFFF + remainder
	rd %psr, %i3 	
	...
	set 0x80000000,%l0 
	set 0x000000A5,%l1 
	sdivcc %l0,%l1,%l5			! Result is 0x7FFFFFFF. V is set since result > 0x7FFFFFFF + remainder
	rd %psr, %i4 	

	! Check for Set V for negetive result
	mov 0x00000052,%y
	set 0x800000A4,%l0 
	set 0xFFFFFF5B,%l1 
	sdivcc %l0,%l1,%l6			! Result is 0x80000000. V is not set since result < 0xFFFFFFFF + remainder
	rd %psr, %i5 	
	...
	set 0x800000A5,%l0 
	set 0xFFFFFF5B,%l1 
	sdivcc %l0,%l1,%l7			! Result is 0x80000000. V is set since result > 0xFFFFFFFF + remainder
	rd %psr, %i6 	
...
HW_trap_0x2a: inc %g2; rett %r18; nop; nop	!DIV BY 0 TRAP : increment g2 and return
