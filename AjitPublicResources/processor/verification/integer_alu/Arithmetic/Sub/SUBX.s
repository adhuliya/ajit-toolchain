...
_start:
	...
	!subx two positive numbers  
	set 0x2, %l0
	subx %l0, 0x3, %o0	! Expected o0=0xFFFFFFFE
	rd %psr, %o1		! Expected o1=0x001000E0

	!subx two negative numbers, result is zero
	set -2, %l0
	set -3, %l1
	subx %l0, %l1, %o2	! Expected o2=0x00000000
	rd %psr, %o3		! Expected o3=0x001000E0

	!subx negative and positive, result is negative
	set -2, %l0
	set  3, %l1
	subx %l0, %l1, %o4	! Expected o4=0xFFFFFFFA
	rd %psr, %o5		! Expected o5=0x001000E0
	
	!subx negative and positive, result is positive
	set 2, %l0
	set -3, %l1
	subx %l0, %l1, %o6	! Expected o6=0x00000004
	rd %psr, %o7		! Expected o7=0x001000E0
	
	!subx negative and positive,
	set 3, %l0
	set -3, %l1
	subx %l0, %l1, %i0	! Expected i0=0x00000005
	rd %psr, %i1		! Expected l1=0x001000E0


	!subx two large positive numbers to 
	!create zero and an overflow
	set 0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	subx %l0, %l1, %i2	! Expected i2=0xFFFFFFFD
	rd %psr, %i3		! Expected i3=0x001000E0
	
	!subx two large negative numbers to 
	!create a positive result and an overflow
	set -0x7FFFFFFF, %l0
	set 0x7FFFFFFF, %l1
	subx %l0, %l1, %i4	! Expected i4=0x00000001
	...
	set 0x3, %l0
	set 0x2, %l1
	subx %l0, %l1, %i6	! Expected i6=0x00000001
	rd %psr, %i7		! Expected i7=0x004000E0
