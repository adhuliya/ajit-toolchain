...
_start:
	...
	!tsubcctv two positive numbers, CAUSES tag_overflow
	set 0x2, %l0
	tsubcctv %l0, 0x3, %o0	! Expected o0=0x00000000
	rd %psr, %o1		! Expected o1=0x000000E0

	
	!tsubcctv two negative numbers, NO tag_overflow
	set -0x20, %l0
	set -0x30, %l1
	tsubcctv %l0, %l1, %o2	! Expected o2=0x00000010
	rd %psr, %o3		! Expected o3=0x000000E0

	
	
	!tsubcctv negative and positive, CAUSES tag_overflow
	set -0x2, %l0
	set  0x3, %l1
	tsubcctv %l0, %l1, %o4	! Expected o4=0x00000000
	rd %psr, %o5		! Expected o5=0x000000E0
	
	
	!tsubcctv negative and positive CAUSES tag_overflow
	set 0x3, %l0
	set -0x3, %l1
	tsubcctv %l0, %l1, %i0	! Expected i0=0x00000000
	rd %psr, %i1		! Expected l1=0x000000E0


	!tsubcctv two large positive numbers to 
	!create a negative result and an overflow. CAUSES tag_overflow
	set 0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	tsubcctv %l0, %l1, %i2	! Expected i2=0x00000000
	rd %psr, %i3		! Expected i3=0x000000E0
	
	!tsubcctv two large negative numbers to 
	!create a positive result and an overflow CAUSES tag_overflow
	set -0x7FFFFFFF, %l0
	set  0x7FFFFFFF, %l1
	tsubcctv %l0, %l1, %i4	! Expected i4=0x00000000
	rd %psr, %i5		! Expected i5=0x000000E0
