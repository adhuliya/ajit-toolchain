...
_start:
	...
	!
	! instructions = WRASR, RDASR
	! note : two operands are xor'd and result is placed in asr
	...
	nop
	nop
	rd %asr16, %o0		! Expected o0=0xAAAAAA55
	...
	nop
	nop
	rd %asr24, %o1		! Expected o0=0x55555555

	rd %asr30, %o2		! Expected cycle-count-64 high-word
	rd %asr31, %o3		! Expected cycle-count-64 low-word.
