...
_start:
	...
	!
	! instruction = TGE - not(N xor V) (Trap on Greater or Equal) (=N xnor V)
	...
	! after a taken trap, npc value is saved in r18 of new window,
	! which is used to return to the next instruction,
	! ie instruction after the 'trap' instruction.
...
SW_trap_0x83: mov 0x83, %g2; rett %r18; nop; nop		! mov and return to instruction after the trap instruction
SW_trap_0x84: mov 0x84, %g3; rett %r18; nop; nop		! mov and return to instruction after the trap instruction
SW_trap_0x85: mov 0x85, %g4; rett %r18; nop; nop		! mov and return to instruction after the trap instruction
SW_trap_0x86: mov 0x86, %g5; rett %r18; nop; nop		! mov and return to instruction after the trap instruction
SW_trap_0x87: mov 0x87, %g6; rett %r18; nop; nop		! mov and return to instruction after the trap instruction
