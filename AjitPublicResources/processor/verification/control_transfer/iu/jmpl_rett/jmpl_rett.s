...
_start:
	...
	wr %g0, 0x80, %wim  ! window 7 is invalid.
	ba label1
	save  ! causes window overflow-trap.
	mov 0xBAD, %o1  ! control should not return here.

label1:
	mov 0xABC, %o0  ! post save trap should continue from here.
	ta 0
...
HW_trap_0x05:  ! window overflow trap handler
	mov 0xABC, %g2
	jmpl %r18, %r0
	rett %r18+4
	nop
