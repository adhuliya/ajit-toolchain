...
_start:
	...
	set data_A, %o0			! o0 = 0x80
	ld [%o0], %f0 			! f0 = 0x40066666
	set data_B, %o1			! o1 = 0x84
	ld [%o1], %f1 			! f1 = 0x4079999A
	set 0x08, %o2			! o2 = 0x08
	st %f0, [%o2 + 6]	 	! generate mem_not_aligned trap
	...
	st %f1, [%o2]	 		! generate fp_disabled trap
