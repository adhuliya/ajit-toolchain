! Instruction being verified : stdf
! Author : Titto Thomas
! 5 September 2015
!
...
_start:
	...
	set data_A, %o0		! o0 = 0x74
	set 0x8, %o1		! o1 = 0x8
	ld [%o0], %f1 		! generate fp_disabled trap
	ld [%o0 + 4], %f0	! generate fp_disabled trap
	std %f0, [%o1]		! generate fp_disabled trap
	...
	ld [%o0], %f1 		! f1 = 0x40066666
	ld [%o0 + 4], %f0	! f0 = 0x4079999A	
	std %f0, [%o1]		! mem[0x8] = 0x4079999A, mem[0x0C] = 0x40066666
