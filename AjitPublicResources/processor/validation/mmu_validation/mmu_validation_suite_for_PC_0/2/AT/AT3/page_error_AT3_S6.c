/*----------------------------------------------------------------------------
Filename:			page_error_AT3_S6.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=3 and PTE.ACC=6
...
2.	Setup a context table, and page tables 
	...
	For context 1:
	virtual address			phy address
	0x00001000 - 0x00001FFF 	0x00001000 - 0x00001FFF with PTE.ACC=6
...
//--------------------------------setting page table---------------------------------------------------
	...
	process2_L1PageTable[0x0] = convertPhyAddrToPTD((uint32_t)process2_L2PageTable);//
	...
	process2_PTE = ((0x00000100) | 0x9A );//PTE.ACC=6
