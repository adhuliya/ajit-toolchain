/*----------------------------------------------------------------------------
Filename:			page_error_AT1_S1.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=0 and PTE.ACC=1
...
2.	Setup a context table, and page tables 
	...
	0x00011000 - 0x00012000 	0x00031000 - 0x00032000 with PTE.ACC=1
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process1_PTE = (0x00003100) | 0x86 ;//PTE.ACC=1
