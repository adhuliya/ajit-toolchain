/*----------------------------------------------------------------------------
Filename:			page_error_AT0_S7.c
Version:			1.00
Goal: 				Fault Type=3 for Acess Type=0 and PTE.ACC=7
...
2.	Setup a context table, and page tables 
	...
	0x00011000 - 0x00012000 	0x00031000 - 0x00032000 with PTE.ACC=7
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process1_PTE = (0x00003100) | 0x9E ;//PTE.ACC=7
