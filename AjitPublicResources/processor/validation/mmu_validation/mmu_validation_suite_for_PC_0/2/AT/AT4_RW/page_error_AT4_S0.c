/*----------------------------------------------------------------------------
Filename:			page_error_AT4_S0.c
Version:			1.00
Goal: 				Fault Type=2 for Acess Type=4 and PTE.ACC=0
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	// j=(uint32_t*)0xC0000000;
	// *j=9;
	// j=(uint32_t*)0x0000000C;
	// *j=8;	 
	__asm__ __volatile__("set 0xB0000000, %l4 ");
	__asm__ __volatile__( "mov 0x8, %g6  ");
