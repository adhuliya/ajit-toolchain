! Dcache Tests to count hits and misses.
! run with num sets =2 and associativity =1
...
_start:
	...
	! Perform 16 byte loads to
	! addresses 0 to 0xF.
	! we expect 2 misses and 14 hits
	...
	! Perform 16 byte loads again to
	! addresses 0 to 0xF.
	! we expect 2 read misses and 30 hits
	...
	! FLUSH THE DCACHE
	! Dcache is flushed with alternate-space store
	! with asi=0x13
	sta %g0, [%g0] 0x13


	! Perform 16 byte stores again to
	! addresses 0 to 0xF.
	! we expect 4 write misses and 28 write hits
