...
uint32_t executeInstruction( ThreadState *s, 
				Opcode opcode, 
...
uint32_t executeLoad(Opcode op, uint32_t operand1, uint32_t operand2, uint32_t *result_h, uint32_t *result_l,
		StatusRegisters *status_reg, uint32_t trap_vector, uint8_t asi, uint8_t rd, uint8_t *flags, ThreadState *state);
uint32_t executeStore( Opcode op, uint32_t operand1, uint32_t operand2, uint32_t *result_h, uint32_t *result_l, 
			...
			uint32_t trap_vector, uint8_t asi, uint8_t rd, ThreadState *state);
uint32_t executeLdstub(Opcode op, uint32_t operand1, uint32_t operand2, 
			...
			uint32_t trap_vector, uint8_t asi, uint8_t *flags, ThreadState* state);
