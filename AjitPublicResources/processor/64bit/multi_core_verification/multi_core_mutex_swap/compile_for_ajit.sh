...
compileToSparc.py -o 0 -s init.s -s setup_page_tables.s  -s $AJIT_PROJECT_HOME/tools/ajit_access_routines_mt/asm/trap_handlers.s -I $AJIT_PROJECT_HOME/tools/ajit_access_routines_mt/include -C $AJIT_PROJECT_HOME/tools/ajit_access_routines_mt/src -C $AJIT_PROJECT_HOME/tools/minimal_printf_timer/src -I $AJIT_PROJECT_HOME/tools/minimal_printf_timer/include -c main.c  -E mem_bw.elf -V mem_bw.vars -H mem_bw.hex -M mem_bw.mmap -O mem_bw.objdump  -L LinkerScript.lnk 
