...
def setGlobals(work_dir):
   ...
   # path of validation_parallel2.py
   path_validation_inner = ajit_project_home + "/tools/scripts/validation_inner_env_v5.py"
...
def help_sec ():
   ...
   print ( 
           ...
           ------------------------
           CLEANUP:"
              validation_outer_env_v4.py -c PATHS...
                  cleans up the compiled/ log/ and trace_files/ 
                  folders recursively from PATH"
          ----------------------------------------------------------------------------------------------------------------
          For multicore tests Specify no of cores, threads and version as follows in .vprj file-\n CORES = 1/2/3/4\n THREADS = 1/2\n VERSION =32/64 
          ----------------------------------------------------------------------------------------------------------------
          ''' )
