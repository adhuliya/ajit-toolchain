! Test for checking "slld instruction"
!
...
_start:
	...
	mov 0x1, %g6
	mov 0x1, %g7
	slld %g6,0x20,%l6  				! l4 = 0x00020000

	! Shift by 63
	!
	mov 0x1, %g6
	mov 0x1, %g7
	slld %g6,0x3f,%o0  				! l5 = 0x80000000
