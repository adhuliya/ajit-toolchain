...
start:
	...
	!======= VECTOR FLOAT=================
        ...
        fmovs %f2,%f3
        vfsub %f0,%f2,%f6  	 !result should be 1.1
        ...
        vfmul %f0,%f2,%f8     !final answer = 4.4
        ...
        fmovs %f2,%f3         !value is in f2 and f3
        restore
        vfdiv %f0,%f2,%f10     !final value = 0.5
        ...
        fmovs %f0,%f2
        fmovs %f0,%f3
        vfsqrt %f0,%f2,%f12    	 !output will be 1
	...
	!=======CSWAP=====================
        ...
        add %g2, -8, %g2
        mov 0x3, %g1
        cswapd   [%g2 + %g1   ] 0x08, %i0
        cswapd   [%g2 + 0x3]     , %i2
        cswapda  [%g2 + %g1   ] 0x0A, %i4
