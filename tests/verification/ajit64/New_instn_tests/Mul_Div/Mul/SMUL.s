! Test for checking 'smul instruction'
!
...
_start:
	...
	set 0x00,%g2 
        ...
        set 0x00,%g4
	set 0x02,%g5 
	smuld %g2,%g4,%l0 				! Result of multiplication is 0x06
	rd %psr, %i1

	! Multiply a positive and a negetive number
	set 0x00,%g2
        set 0x03,%g3
        set 0xFFFFFFFF,%g4
	set 0xFFFFFFFE,%g5
	smuld %g2,%g4,%l2 				! Result of multiplication is 0xFFFFFFFFFFFFFFFFFA
	rd %psr, %i2

	! Multiply 2 negetive numbers
	set 0xFFFFFFFF,%g2
        set 0xFFFFFFFD,%g3
        set 0xFFFFFFFF,%g4
	set 0xFFFFFFFE,%g5
	smuld %g2,%g4,%l4 				! Result of multiplication is 0x06
	rd %psr, %i3
