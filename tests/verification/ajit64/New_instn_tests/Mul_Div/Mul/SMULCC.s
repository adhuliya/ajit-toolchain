! Test for checking 'smulcc instruction'
!
...
_start:
	...
	set 0x03,%g2
        ...
        set 0x00,%g4 
	set 0x00,%g5 
	smuldcc %g2,%g4,%l0 				! Result of multiplication is 0x00. Z is set
	rd %psr, %i1

	! Check for set n (set only if lower word is negetive)
	set 0x00,%g2
        set 0x03,%g3
	set 0xFFFFFFFF,%g4
        set 0xFFFFFFFE,%g5
	smuldcc %g2,%g4,%l2 				! Result of multiplication is 0xFFFFFFFFFFFFFFFFFA. N is set
	rd %psr, %i2
