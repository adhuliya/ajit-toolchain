! Test for checking 'umulcc instruction'
!
...
_start:
	...
	set 0x00,%g4 
	set 0x00,%g5 
	umuldcc %g2,%g4,%l0 				! Result of multiplication is 0x00. Z is set 
	rd %psr, %i1
	...
	set 0xFFFFFFFF,%g4
	set 0xFFFFFFFE,%g5
	umuldcc %g2,%g4,%l2 				! Result of multiplication is 0x02FFFFFFFA. N is set 
	rd %psr, %i2
