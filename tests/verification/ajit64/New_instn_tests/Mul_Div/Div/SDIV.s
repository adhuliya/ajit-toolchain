! Test for checking 'sdiv instruction'
!
...
_start:
	...
	set 0x0000000A,%l2
	set 0x0000000A,%l3 
	sdivd %l0,%l2,%l4			! Result is 0x00 
	rd %psr, %i1 

	! Div by 0. Causes trap at 0x2A
	set 0x00000001,%l6	
	set 0x00000001,%l7
	set 0x00000000,%g2			! Set g2 = 0. Incremented if trap occurs
	set 0x0000000A,%l0
	set 0x0000000A,%l1 
	set 0x00000000,%l2
	set 0x00000000,%l3 
	sdivd %l0,%l2,%l6			! Div by 0. Register retains original value (0x01)
	rd %psr, %i2 


	! Divide 2 positive numbers
	set 0x00000052,%l2
	set 0x000007B9,%l3
	set 0x80000294,%l0 
	set 0x000001A5,%l1 
	sdivd %l0,%l2,%o0			! Result is 0x80000004
	rd %psr, %i3 	
	...
	set 0xFFFFFFFF,%l2
	set 0xFFFFFF5B,%l3
	sdivd %l0,%l2,%o4			! Result is -0x02 = 0xFFFFFFFE
	rd %psr, %i5 
	...
	set 0x00000000,%l2 
	set 0x000000A5,%l3 
	sdivd %l0,%l2,%o6			! Result is -0x02 = 0xFFFFFFFE
	rd %psr, %i6 

	! divide by 1.. returns value
	!mov 0x0, %y
	!set 0xA, %o0
	!set 0x1, %o1
	!sdivd %o0, %o1, %o2			! o2 = 0xA
