...
_start:
	...
	set 0x00000000,%l2
	set 0x00000000,%l3 
	udivd %l0,%l2,%l6			! Div by 0. Register retains original value (0x01)
	rd %psr, %i2 
	...
	set 0x0000000A,%l2 
	set 0x00000345,%l3
	udivd %l0,%l2,%o0			! Result is 0x01
	rd %psr, %i3

	! Divide by 1.
	set 0x0,%l6 
	set 0x1,%l7
	udivd %l0, %l6, %o2			! l7 = 0xA.

	! Divide 2 arbitary numbers
	set 0x00000052,%l0
	set 0x80000294,%l1
        set 0x80000294,%l2 
	set 0x000000A5,%l3 
	udivd %l0,%l2,%o4			! Result is 0x80000004
	rd %psr, %i4 	
