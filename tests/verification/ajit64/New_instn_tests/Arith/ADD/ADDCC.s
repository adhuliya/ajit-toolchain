...
_start:
	...
	set 0x3, %l2
	set 0x3, %l3
	adddcc %l0, %l2, %o0	! Expected o0,o1=0x00000005
	rd %psr, %i4		! Expected i4=0xE0
	...
	set 0xffffffff, %l2
	set -2, %l3
	adddcc %l0, %l2, %o2	! Expected o2,o3=0xFFFFFFFC
	rd %psr, %i5		! Expected i5=0x9000E0
	...
	set  3, %l3
	set  0, %l2
	adddcc %l0, %l2, %o4	! Expected o4=0, o5=1
	rd %psr, %i6		! Expected i6=0x1000E0
	...
	set  1, %l3
	set  0, %l2
	adddcc %l0, %l2, %o6	! Expected o6=0xFFFFFFFF, o7 =0xffffffff
	rd %psr, %i7		! Expected i7=0x8000E0
	...
	set 0x7fffffff, %l2
	set 0xffffffff, %l3
	adddcc %l0, %l2, %i0	! Expected i0=0xEFFFFFFF, i1=0xfffffffe
	rd %psr, %l4		! Expected l4=0xa000E0
	...
	set 0x80000000, %l2
	set 0x00000001, %l3
	adddcc %l0, %l2, %i2	! Expected i2=0xffffffff, i3 =oxffffffffc
	rd %psr, %l5		! Expected l5=0x3000E0
	...
	set 0xffffffff, %l0
	set 0xfffffffe, %l1
	adddcc %l0, %l2, %l6	! Expected l6,l7=0x0
	rd %psr, %l0		! Expected l0=0x4000E0
