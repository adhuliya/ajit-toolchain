...
_start:
	...
	set 0x0, %l2
	set 0x3, %l3
	subdcc %l0, %l2, %o4	! Expected o4=FFFFFFFB
	rd %psr, %i6		! Expected o5=0x8000E0
	...
	set 0xffffffff, %l2
	set 0xfffffffd, %l3
	subdcc %l0, %l2, %o6	! Expected o6=0x00000005
	...
	set 0x0, %l2
	set 0x3, %l3
	subdcc %l0, %l2, %l6	! Expected i4=0x00000001
	rd %psr, %l0		! Expected i5=04000E0
