...
_start:
	...
	set 0x0, %l2
	set 0x3, %l3
	subd %l0, %l2, %o0	! Expected o0=o1=0xFFFFFFFF
	...
	set 0xffffffff, %l2
	set 0xfffffffd, %l3
	subd %l0, %l2, %o2	! Expected o2=0,o3=0x00000001
	...
	set 0x0, %l2
	set 0x3, %l3
	subd %l0, %l2, %o4	! Expected o4=FFFFFFFB
	rd %psr, %i6		! Expected o5=0xE0
	
	!sub positive and negative, result is positive
	set 0x0, %l0
	set 0x2, %l1
	set 0xffffffff, %l2
	set 0xfffffffd, %l3
	subd %l0, %l2, %o6	! Expected o6=0x00000005
	rd %psr, %i7		! Expected o7=0xE0
	...
	set 0x80000000, %l2
	set 0x00000001,%l3
	subd %l0, %l2, %i0	! Expected i0=0xFFFFFFFE
	rd %psr, %l4		! Expected i1=0xE0
	...
	set 0x7FFFFFFF, %l2
	set 0xfffffffe, %l3
	subd %l0, %l2, %i2	! Expected i2=0x00000002
	rd %psr, %l5		! Expected i3=0xE0
