/*----------------------------------------------------------------------------
Filename:			PTE_with_ET3_level1.c
Version:			1.00
Goal: 				translation error for PTE with 3 at level1
...
line 189:uint32_t process1_PTE2 = ((0xA0<<12)<<8) | 0x8F ;//PTE with ET=3
-----------------------------------------------------------------------------*/
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process1_PTE2 = ((0xA0<<12)<<8) | 0x8F ;//0x8E
	process1_L1PageTable[0x10] = process1_PTE2;
