...
Perform a simple context switch.
...
_start:
	...
	set 0xcc3, %g3	!CHECKPOINT
	
	!Now switch to context 1
	mov  1, %o0		! call context_switch(1)
	call  context_switch
	nop 
	sethi  %hi(0x10000000), %g7
	nop
	set 0xcc4, %g3	!CHECKPOINT
	nop
	ta 0
	nop
	nop
