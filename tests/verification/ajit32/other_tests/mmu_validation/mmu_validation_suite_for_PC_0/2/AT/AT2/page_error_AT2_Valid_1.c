/*----------------------------------------------------------------------------
Filename:			page_error_AT2_Valid_1.c
Version:			1.00
Goal: 				Fault Type=1 for Acess Type=2 and PTE.V=0
...
//--------------------------------setting page table---------------------------------------------------
	...
	process2_PTE = ((0x00000100) | 0x00 );//0x9E or 0x9A 0r 0x 92 PTE.V=0
	...
	process2_PTE = ((0x00000300) | 0x9A );//0x9E or 0x9A 0r 0x 92
