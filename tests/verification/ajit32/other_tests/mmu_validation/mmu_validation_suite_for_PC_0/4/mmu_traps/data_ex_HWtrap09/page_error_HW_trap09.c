/*----------------------------------------------------------------------------
Filename:			page_error_HW_trap09.c
Version:			1.00
Goal: 				Generate HW trap of no 9. data access exception (0x09 )
Author:				Harshal Kalyane
Description:	
			Traps are generated by MMU when illegal memory reference take place. Mainly
four traps are generated.
No entry for 0xC0000000 VA in process 1 page table. Will generate invalid address error hence data access exception
line 305:	__asm__ __volatile__("set 0xC0000000, %l4 ");
-----------------------------------------------------------------------------*/
...
__asm__ (".global TRAP_TABLE; .align 4096; TRAP_TABLE:\n  HW_trap_0x00: mov 0xf0, %g5; restore; ta 0; nop;\
