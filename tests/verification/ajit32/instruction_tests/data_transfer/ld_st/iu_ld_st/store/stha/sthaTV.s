! Instruction being verified : stha
! Author : Titto Thomas
! 5 September 2015
!
...
_start:
	...
	set 0x7, %o0			! o0 = 0x6
	set 0xFFFFA001, %l1		! l1 = 0xFFFFA001
	stha %l1, [%o0]0x20  		! generate mem_not_aligned trap
	...
	set 0x8, %o1			! o1 = 0x8
	set 0x5002, %l2			! l2 = 0x5002
	stha %l2, [%o1]0x20  		! generate no_previliged_instruction trap
