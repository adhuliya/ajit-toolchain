! Instruction being verified : lda
! Author : Titto Thomas
! 29 August 2015
!
...
_start:
	...
	set data_A, %o0
	add 0x01, %o0, %o0		! o0 = 0x91
	lda [%o0]0x20, %l0  		! generates mem_not_aligned trap
	nop
	...
	!load the second number and the previous one
	set data_B, %o1			! o1 = 0x94
	lda [%o1]0x20, %l3  		! generates not_previliged_instruction trap
	nop
...
HW_trap_0x02: mov 0x01, %g1; restore; ta 0; nop
