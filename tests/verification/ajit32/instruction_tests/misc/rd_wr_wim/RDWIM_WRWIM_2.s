...
_start:
	...
	!
	! instructions = WRWIM, RDWIM
	! NOTE on a write, bits 31:8 of wim register remain unchanged
	! because they correspond to non-existant windows (NWINDOWS=8)
	! note : the two operands are 'xor'd to get the result
	...
	nop
	nop
	rd %wim, %o0		! Expected o0=0x00000010 => window 4 is invalid
	...
	nop
	nop
	rd %wim, %o1		! Expected o0=0x00000008 => window 3 is invalid
	...
	rd %wim, %o3		! Should cause a trap. o3=0x00000000
