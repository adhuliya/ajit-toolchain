! Test for checking "xnorcc instruction"
...
_start:
	...
	sethi %hi(0x2AAAAAAA),%g3
	or    %g3,%lo(0x2AAAAAAA),%g3
	rd %psr, %i0
	xnorcc %g2,%g3,%g4 
	rd %psr, %i1 
	...
	! Check for set z
	sethi %hi(0x55555555),%l0
	or    %l0,%lo(0x55555555),%l0
	sethi %hi(0xAAAAAAAA),%l1
	or    %l1,%lo(0xAAAAAAAA),%l1
	xnorcc %l0,%l1,%l2 
	rd %psr, %i2
