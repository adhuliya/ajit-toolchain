! Test for checking "srl instruction"
...
_start:
	...
	mov 0x01,%g3
	rd %psr, %i0
	srl %g2,%g3,%l1 				! l1 = 0x40000000
	rd %psr, %i1

	! Shift by 2
	! Note: only bottom 5 bits used in shift
	! amount.  Top 27 bits ignored.
	mov 0xffffff02,%g3
	srl %l1,%g3,%l2  				! l2 = 0x10000000
	rd %psr, %i2


	! Shift by 0
	mov 0x00,%g3
	srl %l2,%g3,%l3  				! l3 = 0x10000000
	rd %psr, %i3
