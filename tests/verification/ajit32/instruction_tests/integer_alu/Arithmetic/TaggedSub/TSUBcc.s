...
_start:
	...
	!tsubcc two positive numbers, causes tag_overflow
	set 0x2, %l0
	tsubcc %l0, 0x3, %o0	! Expected o0=0xFFFFFFFF
	rd %psr, %o1		! Expected o1=0x00B000E0

	!tsubcc two negative numbers, no tag_overflow
	set -0x20, %l0
	set -0x30, %l1
	tsubcc %l0, %l1, %o2	! Expected o2=0x00000010
	rd %psr, %o3		! Expected o3=0x000000E0

	!tsubcc negative and positive causes tag_overflow
	set -0x2, %l0
	set  0x3, %l1
	tsubcc %l0, %l1, %o4	! Expected o4=0xFFFFFFFB
	rd %psr, %o5		! Expected o5=0x00A000E0
	
	!tsubcc negative and positive no tag_overflow
	set 0x20, %l0
	set -0x30, %l1
	tsubcc %l0, %l1, %o6	! Expected o6=0x00000050
	rd %psr, %o7		! Expected o7=0x001000E0
	
	!tsubcc negative and positive,  causes tag_overflow
	set 0x3, %l0
	set -0x3, %l1
	tsubcc %l0, %l1, %i0	! Expected i0=0x00000006
	rd %psr, %i1		! Expected l1=0x003000E0


	!tsubcc two large positive numbers to 
	!create a negative result and an overflow
	set 0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	tsubcc %l0, %l1, %i2	! Expected i2=0xFFFFFFFE
	rd %psr, %i3		! Expected i3=0x00B000E0
	
	!tsubcc two large negative numbers to 
	!create a positive result and an overflow
	set -0x7FFFFFFF, %l0
	set  0x7FFFFFFF, %l1
	tsubcc %l0, %l1, %i4	! Expected i4=0x00000002
	rd %psr, %i5		! Expected i5=0x002000E0
