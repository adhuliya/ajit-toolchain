...
! All coprocessor branch operations should generate a Cp_disabled trap,
!
...
_start:
	...
	! Initialize PSR, enable traps and Coprocessor unit
	! set PSR with ET=1 PS=1 S=1 EC=1,  all other fields=0
	...
	!
	! instruction = branch on coprocessor condition codes
	! should cause a CP_disabled trap (hardware trap number 0x24),
	! beacuse CP is not present,
...
HW_trap_0x24: inc %g2; rett %r18 ; nop; nop ! <======CP_DISABLED trap handler
