! Test for instruction: RETT (Test illegal instruction trap) 
...
_start:
	...
	! instruction = RETT
	!
	! Test illegal instruction trap (ET=1, S=1, PS=1, CWP=0)
	...
	set label2, %l0
	rett %l0	!causes illegal instr trap
	mov 0xDEF, %g4	!<--- NOT executed because rett traps.
			! Expected g4=0x0

	! Expected g1=0x3 (set in illegal_instruction trap handler)	
