...
_start:
	...
	!
	! instruction = FBL (Branch on Less) (L)
	...
	fbl label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbl label2	! conditional branch that is *not* taken
...
label2:
	...
	fbl label3	! conditional branch that is taken
...
label3: 
	...
	fbl label4	! conditional branch that is *not* taken 
...
label4:
	...
	fbl label5	! conditional branch that is *not* taken 
