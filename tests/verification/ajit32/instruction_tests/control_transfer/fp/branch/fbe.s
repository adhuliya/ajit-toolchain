...
_start:
	...
	!
	! instruction = FBE (Branch on Equal) (E)
	...
	fbe label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbe label2	! conditional branch that is *not* taken
...
label2:
	...
	fbe label3	! conditional branch that is taken
...
label3: 
	...
	fbe label4	! conditional branch that is *not* taken 
...
label4:
	...
	fbe label5	! conditional branch that is *not* taken 
