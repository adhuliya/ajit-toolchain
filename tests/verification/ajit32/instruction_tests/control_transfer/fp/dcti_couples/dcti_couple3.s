...
_start:
	...
	fbl,a label2	! conditional ANNULLED branch that is *not* taken

	mov 0xF00, %g3	! delay slot instruction is never executed 

label1:
	add %o1, 0x3, %o0	! This is ANNULLED and not executed
	mov 0x88, %g4		! control reaches here because fbl is not taken


label2: add %o0, 0x3, %o1	! Expected o1=0x00000004
