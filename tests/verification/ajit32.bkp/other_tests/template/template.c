// This is a  template for writing sparc tests using C and inline assembly.
// It demonstrates how to read and write to processor registers.
//
//
...
{
	//Read y register and print it
	y = get_y();
	putString("\n Hello. y= ");
	putInt(y);
	putString("\n");
	
	//modify register inline:
	__asm__ __volatile__( "mov 1234, %g1\n\t ");
	//modify a register using  a function:
	put_g1(5678);
