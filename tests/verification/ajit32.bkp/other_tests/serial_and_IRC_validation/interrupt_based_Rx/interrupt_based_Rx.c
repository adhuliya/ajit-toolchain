// Interrupt based input using serial device
// Author: Neha Karanjkar
//
//Scheme : 
//	Upon receiving a character on the RX pin, the serial device 
//	genrates an interrupt to the cpu (hardware interrupt number 12)
//
//	The trap handler for this interrupt reads the character from 
//	the Rx register and stores it in an input buffer in memory.
//
//	Whenever the user program needs to perform input,
//	it should read a character from the input buffer.
