/*----------------------------------------------------------------------------
Filename:			MMU_Probing_No_PTE.c
Version:			1.00
Goal: 				Probing in MMU
Author:				Harshal Kalyane
Description:	
			This test case ,error generated by MMU at time probing. if PTE is not found in probing. 
...
int  __attribute__((section(".text.main")))  startTest()
{
	...
	//address range 0x1000 0000 to 0x1100 0000
	uint32_t process1_PTE = ((0xA0<<12)<<8) | 0x8D ;
	...
	uint32_t expected_probe_value = 0x0A00008D;
