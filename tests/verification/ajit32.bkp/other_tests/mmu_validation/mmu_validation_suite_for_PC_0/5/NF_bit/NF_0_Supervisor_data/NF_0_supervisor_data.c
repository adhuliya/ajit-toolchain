//Test functionality of NF(no fault) bit, when NF=0
//for supervisor load/store access.
//
...
//	Set NF=0 and enable the MMU
//	Perform a supervisor-level load to an address 
//	that is not mapepd in the mmu
//
//	This should cause a data access exception trap (trap-type=09)
// 	Check FSR and FAR	
...
int  __attribute__((section(".text.main"))) startTest()
{
	...
	//update FSR and FAR, and a trap is caused
...
HW_trap_0x09: mov 0x09, %g5; restore; ta 0; nop; ! Data access exception\
