/*----------------------------------------------------------------------------
Filename:			page_error_AT0_Valid_1.c
Version:			1.00
Goal: 				Fault Type=1 for Acess Type=0 and PTE.V=0
...
2.	Setup a context table, and page tables 
	...
	0x00011000 - 0x00012000 	0x00031000 - 0x00032000  with PTE.V=0
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process1_PTE = (0x00003100)  | 0x82 ;//0x8E
