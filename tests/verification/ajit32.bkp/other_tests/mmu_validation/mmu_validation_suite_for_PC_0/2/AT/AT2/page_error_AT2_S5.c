/*----------------------------------------------------------------------------
Filename:			page_error_AT2_S5.c
Version:			1.00
Goal: 				Fault Type=2 for Acess Type=2 and PTE.ACC=5
...
2.	Setup a context table, and page tables 
	...
	For context 1:
	virtual address			phy address
	0x00001000 - 0x00001FFF 	0x00001000 - 0x00001FFF with PTE.ACC=5
	
3.	Try to execute instruction from Address Space = 0x00001xxx 
...
//--------------------------------setting page table---------------------------------------------------
	...
	process2_PTE = ((0x00000100) | 0x96);//change permission here PTE.ACC=5
