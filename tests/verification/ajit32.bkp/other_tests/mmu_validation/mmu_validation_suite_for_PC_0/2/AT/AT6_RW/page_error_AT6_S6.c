/*----------------------------------------------------------------------------
Filename:			page_error_AT6_S6.c
Version:			1.00
Goal: 				Fault Type=3 for Acess Type=6 and PTE.ACC=6
...
4.	MOV 0x3 to %g6
5.	In context 0 write data(%g6) using virtual addr(0x10000000) using ASI=0x08.
...
//--------------------------------setting page table---------------------------------------------------
	...
	// 1 0 0 110 10 = 0x9A user:No Acess. Super:Read/Execute.
	// 1 0 0 111 10 = 0x9E user:No Acess. Super:Read/Write/Execute.
	uint32_t process1_PTE = ((0xA0<<12)<<8) | 0x9A ;//PTE.ACC=6
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	...
	__asm__ __volatile__("sta %g6 , [%l4] 0x08 " );//asi=0x08 for user instruction space
