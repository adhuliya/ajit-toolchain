/*----------------------------------------------------------------------------
Filename:			page_error_AT7_S1.c
Version:			1.00
Goal: 				Fault Type=2 for Acess Type=7 and PTE.ACC=1
...
2.	Setup a context table, and page tables 
	...
	0x10000000 - 0x10001000 	0xA0000000-0xA00001000 with PTE.ACC=1
...
//--------------------------------setting page table---------------------------------------------------
	...
	// 1 0 0 110 10 = 0x9A user:No Acess. Super:Read/Execute.
	// 1 0 0 111 10 = 0x9E user:No Acess. Super:Read/Write/Execute.
	uint32_t process1_PTE = ((0xA0<<12)<<8) | 0x86 ;//PTE.ACC=1
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	...
	__asm__ __volatile__("sta %g6 , [%l4] 0x09 " );//asi=0x08 for supervisor instruction space
