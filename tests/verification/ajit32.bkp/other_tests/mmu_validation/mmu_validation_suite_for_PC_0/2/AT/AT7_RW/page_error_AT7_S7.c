/*----------------------------------------------------------------------------
Filename:			page_error_AT7_S7.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=7 and PTE.ACC=7
...
2.	Setup a context table, and page tables 
	...
	0x10000000 - 0x10001000 	0xA0000000-0xA00001000 with PTE.ACC=7
...
//--------------------------------setting page table---------------------------------------------------
	...
	// 1 0 0 110 10 = 0x9A user:No Acess. Super:Read/Execute.
	// 1 0 0 111 10 = 0x9E user:No Acess. Super:Read/Write/Execute.
	uint32_t process1_PTE = ((0xA0<<12)<<8) | 0x9E ;//PTE.ACC=7
