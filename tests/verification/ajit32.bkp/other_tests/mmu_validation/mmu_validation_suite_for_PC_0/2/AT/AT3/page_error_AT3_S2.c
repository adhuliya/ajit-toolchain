/*----------------------------------------------------------------------------
Filename:			page_error_AT3_S2.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=3 and PTE.ACC=2
...
//--------------------------------setting page table---------------------------------------------------
	...
	process2_PTE = ((0x00000100) | 0x8A );//PTE.ACC=2
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	...
	__asm__ (".align 4096");//instruction at 0x0000 1000
