/*----------------------------------------------------------------------------
Filename:			page_error_AT1_S4.c
Version:			1.00
Goal: 				Fault Type=2 for Acess Type=0 and PTE.ACC=4
...
2.	Setup a context table, and page tables 
	...
	0x00011000 - 0x00012000 	0x00031000 - 0x00032000 with PTE.ACC=4
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process1_PTE = (0x00003100) | 0x92 ;//PTE.ACC=4
