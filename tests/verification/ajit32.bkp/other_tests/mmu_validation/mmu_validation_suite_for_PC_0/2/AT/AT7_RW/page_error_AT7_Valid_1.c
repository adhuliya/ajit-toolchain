/*----------------------------------------------------------------------------
Filename:			page_error_AT7_Valid_1.c
Version:			1.00
Goal: 				Fault Type=1 for Acess Type=7 and PTE.V=0
...
4.	MOV 0x3 to %g6
5.	In context 0 write data(%g6) using virtual addr(0x20000000) using ASI=0x09.
