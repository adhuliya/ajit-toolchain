/*----------------------------------------------------------------------------
Filename:			page_error_AT5_S7.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=5 and PTE.ACC=7
...
4.	MOV 0x3 to %g6
5.	In context 0 write data(%g6) using virtual addr(0x10000000) from supervisor mode.
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process2_PTE = ((0xA0<<12)<<8) | 0x9A ;//0x9E or 0x9A 0r 0x 92
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	...
	//__asm__ __volatile__("sta %g6 , [%l4]0xA " );
