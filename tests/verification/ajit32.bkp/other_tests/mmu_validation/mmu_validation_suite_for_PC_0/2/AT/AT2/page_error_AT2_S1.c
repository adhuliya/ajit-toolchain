...
2.	Setup a context table, and page tables 
	...
	For context 1:
	virtual address			phy address
	0x00001000 - 0x00001FFF 	0x00001000 - 0x00001FFF with PTE.ACC=1
...
//--------------------------------setting page table---------------------------------------------------
	...
	process2_PTE = ((0x00000100) | 0x86 );//change permission here PTE.ACC=1
	process2_L3PageTable[0x01] = process2_PTE;

	process2_PTE = ((0x00000200) | 0x9A );
	process2_L3PageTable[0x02] = process2_PTE;

	process2_PTE = ((0x00000300) | 0x9A );
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	...
	__asm__ (".align 4096");//program after 0x00001000
