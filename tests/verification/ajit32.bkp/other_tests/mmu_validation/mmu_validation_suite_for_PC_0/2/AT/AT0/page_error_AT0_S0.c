...
//--------------------------------setting page table---------------------------------------------------
	...
	//next map all addresses in range 0x00000000-0x10000000
	//such that VA=PA
	for(i=0x00; i<=0x10; i++)
	{
	...
	uint32_t process1_PTE = (0x00003100) | 0x82 ;//PTE.ACC=0
...
//------------------------------------------------------------------------------------------------------------------
	...
	*j=12;
	...
	// //--------------------------------------------------------------------------------------------------------------
	__asm__ __volatile__("set 0x00010000, %l4 \n\t");//check point
	// //--------------------------------------------------------------------------------------------------------------
	//----------------------------------Go to user mode-------------------------------------------------------------
