/*----------------------------------------------------------------------------
Filename:			page_error_AT5_Valid_1.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=5 and PTE.V=0
...
2.	Setup a context table, and page tables 
	...
	0x10000000 - 0x10001000 	0xA0000000-0xA00001000 with PTE.ACC=0

3.	Write a 0x12 using physical address(0xA0000000)
3. 	Initial context table ptr, context register, and enable MMU.
4.	MOV 0x3 to %g6
5.	In context 0 write data(%g6) using virtual addr(0x20000000) from supervisor mode.
...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process2_PTE = ((0xA0<<12)<<8) | 0x82 ;//0x9E or 0x9A 0r 0x 92
