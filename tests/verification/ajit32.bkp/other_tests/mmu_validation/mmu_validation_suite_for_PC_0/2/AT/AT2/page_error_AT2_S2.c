/*----------------------------------------------------------------------------
Filename:			page_error_AT2_S2.c
Version:			1.00
Goal: 				Fault Type=0 for Acess Type=2 and PTE.ACC=2
...
2.	Setup a context table, and page tables 
	...
	For context 1:
	virtual address			phy address
	0x00001000 - 0x00001FFF 	0x00001000 - 0x00001FFF with PTE.ACC=2
...
//--------------------------------setting page table---------------------------------------------------
	...
	process2_PTE = ((0x00000100) | 0x8A );//change permission here PTE.ACC=2
