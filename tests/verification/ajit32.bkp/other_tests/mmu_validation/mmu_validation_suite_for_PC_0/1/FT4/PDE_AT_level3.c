/*----------------------------------------------------------------------------
Filename:			PDE_AT_level3.c
Version:			1.00
Goal: 				translation error PTD at level3
...
line 269:uint32_t process1_PTE = ((0xA0<<12)<<8) | 0x8D ;//---PTD at level3
...
//--------------------------------setting page table---------------------------------------------------
	...
	// 1 0 0 110 10 = 0x9A user:No Acess. Super:Read/Execute.
	// 1 0 0 111 10 = 0x9E user:No Acess. Super:Read/Write/Execute.
	uint32_t process1_PTE = ((0xA0<<12)<<8) | 0x8D ;//-----------------------PTD at level3
