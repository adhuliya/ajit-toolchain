...
//--------------------------------setting page table---------------------------------------------------
	...
	uint32_t process2_PTE2 = ((0x00000000) | 0x8E );//0x9E or 0x9A 0r 0x 92
	ContextTable[0] = process2_PTE2;
	...
	// 1 0 0 110 10 = 0x9A user:No Acess. Super:Read/Execute.
	// 1 0 0 111 10 = 0x9E user:No Acess. Super:Read/Write/Execute.
	uint32_t process1_PTE = ((0x00<<12)<<8) | 0x8E ;//0x8E
	uint32_t process2_PTE = ((0x00<<12)<<8) | 0x8E ;//0x9E or 0x9A 0r 0x 92
	uint32_t process3_PTE = ((0x00<<12)<<8) | 0x8E ;//0x8E
	process1_L3PageTable[0x00] = process1_PTE;
	process2_L3PageTable[0x00] = process2_PTE;
	process3_L3PageTable[0x00] = process3_PTE;
//------------------------------------------------------------------------------------------------------------------
	 uint32_t *j=(uint32_t*) 0x00000000; //store it at A000 0000 address.
	*j=12;
