/* 
This is a test to see if the FSR register is written correctly upon a 
fault caused by a page table entry of type 3,
in the context table.

First, setup page tables such that Virtual addr = phy addr 
for entire address space, with PTE.ET =0x3. 
Then enable the mmu.
The instruction right after this should fault.
...
_start:
	...
	st  %o0, [%o1]		!Store PTE in ContextTable[0]
	st  %o0, [%o1+4]	!Store PTE in ContextTable[1]
	...
	! This instruction should fault.
	set 0xcc2, %g3	!CHECKPOINT
