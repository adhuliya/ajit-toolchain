...
! first branch is BA, a=1 (annulled), second branch any CTI	
...
_start:
	...
	cmp %g5, %g2	! (V and N flags are set)
	ba,a label1	! branch always, annulled
	bneg label2	! conditional branch that should have been taken
...
label1:
	add %o1, 0x3, %o0	! control reaches here because branch (ba) is taken
				! Expected o0=0x00000005
	mov 0x88, %g4		! control reaches here because bneg is annulled
...
label2: add %o0, 0x3, %o1	! Expected o1=0x00000008
	...
	ba,a label3	! branch always, annulled
	bz label4	! conditional branch that should *not* have been taken
...
label3:
	add %o3, 0x3, %o2	! control reaches here because branch (ba) is taken
