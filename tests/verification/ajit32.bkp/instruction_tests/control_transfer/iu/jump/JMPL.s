...
_start:
	...
	! instruction = JMPL
		...
		set jump_target_minus_four, %g2
pc1	:	jmpl %g2+0x4, %g3	! causes delayed jump to jump_target 
					! and Expected g3=pc1
n_pc1 	:	mov 0xABC, %g4	   	! delay slot instruction. Expected g4=0xABC
		nop
		nop
		nop
		mov 0xDEF, %g4		! control doesn't reach here
		nop
		nop

jump_target_minus_four :	
		nop
jump_target:	set pc1, %g5		! Expected g3=g5=pc1
		nop
	
	! Test trap behavior.
	! if jump_address[1:0] !=0, a mem_address_not_aligned trap should occur
	! %g6 is incremented in the trap handler. Expected g6=0x00000001
		clr %g6 !clear g6
		clr %g7 !clear g7
			
pc2	:	jmpl %g2+0x2, %g7	! causes trap. g7 unmodified.
					! Expected g7=0x00000000
		mov 0xABC, %o0	   	! Expected o0=0xABC
		nop
		ta 0			
		nop
		nop
...
HW_trap_0x07: inc %g6; rett %r18; nop; nop  ! MEM ADDR NOT ALIGNED TRAP
