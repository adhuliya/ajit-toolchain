! Test for instruction: RETT (Test privileged instruction trap, leading to error state) 
...
_start:
	...
	set label2, %l0
	rett %l0	! sets privileged_instruction trap and goes to error mode
