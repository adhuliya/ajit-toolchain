...
_start:
	...
	fbne label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbne label2	! conditional branch that is taken
...
label2:
	...
	fbne label3	! conditional branch that is taken
...
label3: 
	...
	fbne label4	! conditional branch that is taken 
...
label4:
	...
	fbne label5	! conditional branch that is taken 
...
label8:
	...
	fbne,a label9	! conditional ANNULLED branch that is taken
	mov 0xF00, %l0	! delay slot instruction is always executed
	mov 0x55, %l1	! control shouldn't reach here

label9:
	fcmps %f2, %f2  ! both are unordered
	fbne,a label10	! conditional ANNULLED branch that is taken
