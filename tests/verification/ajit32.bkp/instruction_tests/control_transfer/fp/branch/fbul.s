...
_start:
	...
	fbul label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbul label2	! conditional branch that is *not* taken
...
label2:
	...
	fbul label3	! conditional branch that is taken
...
label3: 
	...
	fbul label4	! conditional branch that is taken 
...
label4:
	...
	fbul label5	! conditional branch that is taken 
...
label8:
	...
	fbul,a label9	! conditional ANNULLED branch that is taken
	mov 0xF00, %l0	! delay slot instruction is always executed
	mov 0x55, %l1	! control shouldn't reach here

label9:
	fcmps %f2, %f2  ! both are unordered
	fbul,a label10	! conditional ANNULLED branch that is taken
