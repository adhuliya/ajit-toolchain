...
_start:
	...
	fbuge label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbuge label2	! conditional branch that is taken
...
label2:
	...
	fbuge label3	! conditional branch that is taken
...
label3: 
	...
	fbuge label4	! conditional branch that is taken 
...
label4:
	...
	fbuge label5	! conditional branch that is taken 
...
label7:	
	...
	fbuge,a label8	! conditional ANNULLED branch that is taken
...
label8:
	...
	fbuge,a label9	! conditional ANNULLED branch that is taken
	mov 0xF00, %l0	! delay slot instruction is always executed
	mov 0x55, %l1	! control shouldn't reach here

label9:
	fcmps %f2, %f2  ! both are unordered
	fbuge,a label10	! conditional ANNULLED branch that is taken
