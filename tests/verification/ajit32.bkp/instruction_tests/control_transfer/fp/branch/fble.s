...
_start:
	...
	!
	! instruction = FBLE (Branch on Less or Equal) (L or E)
	...
	fcmps %f1, %f0  ! compare f1, f0 (greater)
	fble label1	! conditional branch that is *not* taken 
	mov 0xF00, %o0	! delay slot instruction is always executed
	mov 0x66, %o2	! control should reach here

label1:	
	fcmps %f0, %f1  ! compare f0, f1 (less)
	fble label2	! conditional branch that is taken
...
label2:
	...
	fble label3	! conditional branch that is taken
...
label3: 
	...
	fble label4	! conditional branch that is *not* taken 
...
label4:
	...
	fble label5	! conditional branch that is *not* taken 
...
label7:	
	...
	fble,a label8	! conditional ANNULLED branch that is taken
