...
! 
! FP unit-branches 
! All FP unit branch operations should generate a FP_disabled trap,
!
...
main:
_start:
	! Initialize PSR, enable traps and *DONT ENABLE FLOATING POINT UNIT*
	! set PSR with ET=1 PS=1 S=1 EF=0, all other fields=0
	! NOTE: co-processor has to be disabled (EC=0)
	...
	!
	! instruction FP unit instructions
	! should cause a FP_disabled trap (hardware trap number 0x4) 
	! g2 holds the count of how many times the trap occured.
	! Expected g2 = 0x10
...
HW_trap_0x04: inc %g2; rett %r18 ; nop; nop ! <======FP_DISABLED trap handler
