...
_start:
	...
	fbug label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbug label2	! conditional branch that is *not* taken
...
label2:
	...
	fbug label3	! conditional branch that is taken
...
label3: 
	...
	fbug label4	! conditional branch that is taken 
...
label4:
	...
	fbug label5	! conditional branch that is taken 
...
label8:
	...
	fbug,a label9	! conditional ANNULLED branch that is taken
	mov 0xF00, %l0	! delay slot instruction is always executed
	mov 0x55, %l1	! control shouldn't reach here

label9:
	fcmps %f2, %f2  ! both are unordered
	fbug,a label10	! conditional ANNULLED branch that is taken
