...
_start:
	...
	!
	! instruction = FBLG (Branch on Less or Greater) (G or L)
	...
	fblg label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fblg label2	! conditional branch that is taken
...
label2:
	...
	fblg label3	! conditional branch that is taken
...
label3: 
	...
	fblg label4	! conditional branch that is *not* taken 
...
label4:
	...
	fblg label5	! conditional branch that is *not* taken 
