...
_start:
	...
	fbule label1	! conditional branch that is *not* taken 
...
label1:	
	...
	fbule label2	! conditional branch that is taken
...
label2:
	...
	fbule label3	! conditional branch that is taken
...
label3: 
	...
	fbule label4	! conditional branch that is taken 
...
label4:
	...
	fbule label5	! conditional branch that is taken 
...
label7:	
	...
	fbule,a label8	! conditional ANNULLED branch that is taken
...
label8:
	...
	fbule,a label9	! conditional ANNULLED branch that is taken
	mov 0xF00, %l0	! delay slot instruction is always executed
	mov 0x55, %l1	! control shouldn't reach here

label9:
	fcmps %f2, %f2  ! both are unordered
	fbule,a label10	! conditional ANNULLED branch that is taken
