...
!
! instruction = dcti couple : both taken branches
!
...
_start:
	...
	fba label1	! unconditional branch 
	fbe label2	! conditional branch that is taken

	mov 0xF00, %g3	! delay slot instruction is never executed 


label1:
	add %o1, 0x3, %o0	! control reaches here because branch is taken
				! Expected o0=0x00000005
	mov 0x88, %g4		! control should *not* reach here because of 'fbe'


label2: add %o0, 0x3, %o1	! control reaches here because branch is taken
				! Expected o1=0x00000008
