...
_start:
	...
	set 0x10E0, %l0
	nop	! nops here since 
	nop	! set instruction can be delayed
	nop
	wr %l0, %psr
	...
	!sqrt of a positive number
	set A, %l0		! move  address of 5 into l0
	ldd [%l0], %f0		! loads 4.3[0x4014000000000000] to f0-f1 pair
	fsqrtd %f0, %f2		! f2-f3 = sqrt(f0-f1)
