...
_start:
	...
	ld [%l0], %f0		! loads 4.3[0x4089999A] to f0
	ld [%l1], %f1		! loads 8.2[0x41033333] to f1
	fmuls %f0, %f1, %f2	! f2 = f1 * f0
	rd %psr, %o1		! Expected o3=0x10E0

	
	!add negative and positive
	set C, %l2		! move  address of -1.5 into l2
	ld [%l2], %f3		! loads -1.5 to f3 (0xbfc00000)
	fmuls %f0, %f3, %f4	! f4 = f0 * f3
