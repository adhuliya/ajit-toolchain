...
_start:
	...
	mov 0x123, %l0
	stbar	! behaves like a nop 
	stbar
	stbar
	nop	! does nothing, except change PC and nPC
	nop
	nop
	set 0x456, %l1
	
	! Test sethi
	sethi %hi(0xFFFFFFFF), %l2 !expected l2=0xFFFFFC00
	sethi 0x1234, %l3 !expected l3=0x48D000	
	sethi 0x0, %g3    ! g3 = 0x0

	!Test unimp (should cause an illegal instruction trap)
	!g2 is incremented in the trap handler. Expected g2=1
	unimp
