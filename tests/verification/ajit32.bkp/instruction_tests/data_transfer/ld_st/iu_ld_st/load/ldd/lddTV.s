! Instruction being verified : ldd
! Author : Titto Thomas
! 31 August 2015
!
...
_start:
	...
	set data_A, %o0
	ldd [%o0], %l3  		! will not trap since the compiler automatically replaces odd with even registers for double instructions

	!load the second number and the adjacent one
	set data_D, %o1
	ldd [%o1], %l4  		! should generate mem_not_aligned trap
...
HW_trap_0x07: inc %g3; rett %r18; nop; nop	!MEM NOT ALIGNED TRAP : increment g3 and return
