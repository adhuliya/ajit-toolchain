! Instruction being verified : sta
! Author : Titto Thomas
! 5 September 2015
...
_start:
	...
	!store the first number and then the adjacent one
	set 0x5, %o0
	set 0xA0, %l1
	set 0xB0, %l2
	sta %l1, [%o0]0x20		! generate mem_not_aligned trap
	...
	!store the fourth number and then the previous one
	set 0x10, %o1
	set 0xC0, %l5
	set 0xD0, %l6
	sta %l5, [%o1]0x20		! generate no_previliged_instruction trap
