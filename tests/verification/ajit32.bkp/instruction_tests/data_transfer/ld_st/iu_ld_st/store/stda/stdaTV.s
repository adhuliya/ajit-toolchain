! Instruction being verified : stda
! Author : Titto Thomas
! 5 September 2015
!
...
_start:
	...
	set 0xAB, %l2		! l2 = 0xAB
	set 0xCD, %l3		! l3 = 0xCD
	stda %l2, [%o0]0x20		! generate mem_not_aligned trap
	...
	!store the second number and the adjacent one
	set 0x40, %o1		! o1 = 0x40
	set 0x3FC7, %l5		! l5 = 0x3FC7
	set 0x59E2, %l4		! l4 = 0x59E2
	stda %l5, [%o1]0x20  	! generate no_previliged_instruction trap
