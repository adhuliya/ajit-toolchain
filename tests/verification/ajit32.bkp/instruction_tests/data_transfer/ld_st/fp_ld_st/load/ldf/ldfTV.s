! Instruction being verified : ldf
! Author : Titto Thomas
! 5 September 2015
!
...
_start:
	...
	set data_A, %o0		! o0 = 0x6c
	ld [%o0], %f0 		! generate fp_disabled trap
	ld [%o0 + 4],%f1	! generate fp_disabled trap
	...
	set data_B, %o1		! o1 = 0x64
	ld [%o1], %f2  		! f2 = 0x4079999A
	ld [%o1 - 2],%f3	! generate mem_not_aligned trap
...
HW_trap_0x04: inc %g2; rett %r18; nop; nop	! FP DISABLED TRAP : increment g2 and return
