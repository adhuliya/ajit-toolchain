! Instruction being verified : swapa
! Author : Titto Thomas
! 15 September 2015
!
...
_start:
	...
	set data_A+1, %o0	! o0 = 0x8D
	set 0x08, %l1		! 
	swapa [%o0]0x20, %l1		! generate mem_not_aligned trap
	...
	set data_B, %o1		! o1 = 0x90
	set 0x0F, %l2
	swapa [%o1]0x20, %l2 	! generate previliged_instruction trap
...
HW_trap_0x07: inc %g3; rett %r18; nop; nop	! MEM NOT ALIGNED TRAP : increment g2 and return
