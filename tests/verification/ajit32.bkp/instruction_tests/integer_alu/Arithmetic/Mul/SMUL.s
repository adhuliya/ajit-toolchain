...
_start:
	...
	set 0x03,%g2 
	set 0x02,%g3 
	smul %g2,%g3,%l0 				! Result of multiplication is 0x06
	rd %y, %l1 
	rd %psr, %i1
	...
	set 0x03,%g2
	set 0xFFFFFFFE,%g3
	smul %g2,%g3,%l2 				! Result of multiplication is 0xFFFFFFFFFFFFFFFFFA
	rd %y, %l3 
	rd %psr, %i2
	...
	set 0xFFFFFFFD,%g2
	set 0xFFFFFFFE,%g3
	smul %g2,%g3,%l4 				! Result of multiplication is 0x06
	rd %y, %l5 
	rd %psr, %i3
