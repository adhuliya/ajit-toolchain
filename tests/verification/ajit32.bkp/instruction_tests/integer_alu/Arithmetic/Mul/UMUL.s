...
_start:
	...
	set 0x03,%g2 
	set 0x02,%g3 
	umul %g2,%g3,%l0 				! Result of multiplication is 0x06
	rd %y, %l1 
	rd %psr, %i1
	...
	set 0xFFFFFFFE,%g5
	umul %g2,%g3,%l0 				! Result of multiplication is 0x06
	umul %g4,%g5,%l2 				! Result of multiplication is 0x02FFFFFFFA
	rd %y, %l3 
	rd %psr, %i2
	...
	umul %g2,%g3,%l0 				! Result of multiplication is 0x06
	umul %g4,%g5,%l2 				! Result of multiplication is 0x02FFFFFFFA
	umul %g6,%g7,%l4 				! Result of multiplication is 0x4000000000000000
	rd %y, %l5 
	rd %psr, %i3
