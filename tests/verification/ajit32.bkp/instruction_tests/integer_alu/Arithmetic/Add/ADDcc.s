...
_start:
	...
	!addcc two positive numbers
	set 0x2, %l0
	addcc %l0, 0x3, %o0	! Expected o0=0x00000005
	...
	!addcc negative and positive, result is positive
	set -2, %l0
	set  3, %l1
	addcc %l0, %l1, %o4	! Expected o4=0x00000001
	rd %psr, %o5		! Expected o5=0x1000E0
	
	!addcc negative and positive, result is negative
	set 2, %l0
	set -3, %l1
	addcc %l0, %l1, %o6	! Expected o6=0xFFFFFFFF
	rd %psr, %o7		! Expected o7=0x8000E0
	
	!addcc negative and positive, result is zero
	set 3, %l0
	set -3, %l1
	addcc %l0, %l1, %i0	! Expected i0=0x0
	rd %psr, %i1		! Expected l1=0x4000E0


	!addcc two large positive numbers to 
	!create a negative result and an overflow
	set 0x7FFFFFFF, %l0
	set 0x7FFFFFFF, %l1
	addcc %l0, %l1, %i2	! Expected i2=0xFFFFFFFE
	rd %psr, %i3		! Expected i3=0xA000E0
	
	!addcc two large negative numbers to 
	!create a positive result and an overflow
	set -0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	addcc %l0, %l1, %i4	! Expected i4=0x00000002
