...
_start:
	...
	set 0x0000000A,%l0 
	set 0x00000000,%l1 
	udiv %l0,%l1,%l3			! Div by 0. Register retains original value (0x01)
	rd %psr, %i2 
	...
	set 0x80000294,%l0 
	set 0x000001A5,%l1 
	sdiv %l0,%l1,%l4			! Result is 0x80000004
	rd %psr, %i3 	
	...
	set 0x0000014D,%l0 
	set 0xFFFFFF5B,%l1 
	sdiv %l0,%l1,%l6			! Result is -0x02 = 0xFFFFFFFE
	rd %psr, %i5 
	...
	set 0xFFFFFEB5,%l0 
	set 0x000000A5,%l1 
	sdiv %l0,%l1,%l7			! Result is -0x02 = 0xFFFFFFFE
	rd %psr, %i6 
