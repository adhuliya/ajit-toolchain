! Test for checking 'udivcc instruction'
!
...
_start:
	...
	set 0x00000000,%l0 
	set 0x0000000A,%l1 
	udivcc %l0,%l1,%l2			! Result is 0x00. Z is set 
	rd %psr, %i1 
	...
	set 0x80000294,%l0 
	set 0x000000A5,%l1 
	udivcc %l0,%l1,%l3			! Result is 0x80000004. N is set
	rd %psr, %i2 	
	...
	set 0xFFFFFFFF,%l0 
	set 0x000000A5,%l1 
	udivcc %l0,%l1,%l4			! Result is 0xFFFFFFFF. V is not set since result < 0xFFFFFFFF + remainder
	rd %psr, %i3 	
	...
	set 0x00000000,%l0 
	set 0x000000A5,%l1 
	udivcc %l0,%l1,%l5			! Result is 0xFFFFFFFF. V is set since result > 0xFFFFFFFF + remainder
	rd %psr, %i4 	
