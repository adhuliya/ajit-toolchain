...
_start:
	...
	!subxcc two positive numbers
	set_carry_bit
	set 0x2, %l0
	subxcc %l0, 0x3, %o0	! Expected o0=0xFFFFFFFE
	rd %psr, %o1		! Expected o1=0x009000E0

	!subxcc two negative numbers
	set_carry_bit
	set -0x2, %l0
	set -0x3, %l1
	subxcc %l0, %l1, %o2	! Expected o2=0x00000000
	rd %psr, %o3		! Expected o3=0x004000E0

	!subxcc negative and positive
	set_carry_bit
	set -2, %l0
	set  3, %l1
	subxcc %l0, %l1, %o4	! Expected o4=0xFFFFFFFA
	rd %psr, %o5		! Expected o5=0x008000E0
	
	!subxcc positive and negative
	set_carry_bit
	set 2, %l0
	set -3, %l1
	subxcc %l0, %l1, %o6	! Expected o6=0x00000004
	...
	set 3, %l0
	set -3, %l1
	subxcc %l0, %l1, %i0	! Expected i0=0x00000005
	rd %psr, %i1		! Expected i1=0x001000E0


	!subxcc two large positive numbers to 
	!create zero and an overflow
	set_carry_bit
	set 0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	subxcc %l0, %l1, %i2	! Expected i2=0xFFFFFFFD
	rd %psr, %i3		! Expected i3=0x00B000E0
	
	!subxcc two large negative numbers to 
	!create a positive result and an overflow
	set_carry_bit
	set -0x7FFFFFFF, %l0
	set 0x7FFFFFFF, %l1
	subxcc %l0, %l1, %i4	! Expected i4=0x00000001
