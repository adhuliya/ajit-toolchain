...
_start:
	...
	set 0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	sub %l0, %l1, %i0	! Expected i0=0xFFFFFFFE
	...
	set -0x7FFFFFFF, %l0
	set 0x7FFFFFFF, %l1
	sub %l0, %l1, %i2	! Expected i2=0x00000002
