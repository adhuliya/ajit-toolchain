...
_start:
	...
	!subcc two positive numbers
	set 0x2, %l0
	subcc %l0, 0x3, %o0	! Expected o0=0xFFFFFFFF
	rd %psr, %o1		! Expected o1=0x9000E0

	!subcc two negative numbers
	set -0x2, %l0
	set -0x3, %l1
	subcc %l0, %l1, %o2	! Expected o2=0x00000001
	rd %psr, %o3		! Expected o3=0xE0

	!subcc negative and positive, result is negative
	set -0x2, %l0
	set  0x3, %l1
	subcc %l0, %l1, %o4	! Expected o4=FFFFFFFB
	rd %psr, %o5		! Expected o5=0x8000E0
	
	!subcc positive and negative, result is positive
	set 0x2, %l0
	set -0x3, %l1
	subcc %l0, %l1, %o6	! Expected o6=0x00000005
	rd %psr, %o7		! Expected o7=0xE0

	!subcc two large positive numbers to 
	!create a negative result and an overflow
	set 0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	subcc %l0, %l1, %i0	! Expected i0=0xFFFFFFFE
	rd %psr, %i1		! Expected i1=0xB000E0
	
	!subcc two large negative numbers to 
	!create a positive result and an overflow
	set -0x7FFFFFFF, %l0
	set 0x7FFFFFFF, %l1
	subcc %l0, %l1, %i2	! Expected i2=0x00000002
	rd %psr, %i3		! Expected i3=0x2000E0
	...
	set 0x3, %l0
	set 0x2, %l1
	subcc %l0, %l1, %i4	! Expected i4=0x00000001
	rd %psr, %i5		! Expected i5=0xE0
