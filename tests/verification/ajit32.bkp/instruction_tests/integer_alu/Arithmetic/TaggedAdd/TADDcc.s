...
_start:
	...
	!taddcc two positive numbers, causes tag_overflow
	set 0x2, %l0
	taddcc %l0, 0x3, %o0	! Expected o0=0x00000005
	rd %psr, %o1		! Expected o1=0x2000E0

	!taddcc two negative numbers, no tag_overflow
	set -0x20, %l0
	set -0x30, %l1
	taddcc %l0, %l1, %o2	! Expected o2=0xFFFFFFB0
	rd %psr, %o3		! Expected o3=0x09000E0

	!taddcc negative and positive, result is positive, causes tag_overflow
	set -0x2, %l0
	set  0x3, %l1
	taddcc %l0, %l1, %o4	! Expected o4=0x00000001
	rd %psr, %o5		! Expected o5=0x3000E0
	
	!taddcc negative and positive, result is negative, no tag_overflow
	set 0x20, %l0
	set -0x30, %l1
	taddcc %l0, %l1, %o6	! Expected o6=0xFFFFFFF0
	rd %psr, %o7		! Expected o7=0x8000E0
	
	!taddcc negative and positive, result is zero, causes tag_overflow
	set 0x3, %l0
	set -0x3, %l1
	taddcc %l0, %l1, %i0	! Expected i0=0x0
	rd %psr, %i1		! Expected l1=0x6000E0


	!taddcc two large positive numbers to 
	!create a negative result and an overflow
	set 0x7FFFFFFF, %l0
	set 0x7FFFFFFF, %l1
	taddcc %l0, %l1, %i2	! Expected i2=0xFFFFFFFE
	rd %psr, %i3		! Expected i3=0xA000E0
	
	!taddcc two large negative numbers to 
	!create a positive result and an overflow
	set -0x7FFFFFFF, %l0
	set -0x7FFFFFFF, %l1
	taddcc %l0, %l1, %i4	! Expected i4=0x00000002
