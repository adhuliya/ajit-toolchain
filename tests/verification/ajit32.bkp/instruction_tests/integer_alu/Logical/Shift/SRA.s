! Test for checking "sra instruction"
...
_start:
	...
	! Shift by 1 with sign bit 1
	sethi %hi(0xC0000001),%g2
	or    %g2,%lo(0xC0000001),%g2
	mov 0x01,%g3
	rd %psr, %i0
	sra %g2,%g3,%l1 				! l1 = 0xE0000000
	rd %psr, %i1

	! Shift by 2
        !  Only bottom 5 bits of shift-amount to be used
	!
	mov 0xffffff02,%g3
	sra %l1,%g3,%l2  				! l2 = 0xF8000000
	rd %psr, %i2


	! Shift by 0
	mov 0x00,%g3
	sra %l2,%g3,%l3  				! l3 = 0xF8000000
	rd %psr, %i3

	
	! Shift by 1 with sign bit 0
	sethi %hi(0x40000001),%g2
	or    %g2,%lo(0x40000001),%g2
	mov 0x01,%g3
	sra %g2,%g3,%l4 				! l4 = 0x20000000
	rd %psr, %i4
