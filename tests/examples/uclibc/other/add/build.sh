...
compileToSparcUclibc.py -I $AJIT_UCLIBC_HEADERS_DIR -I ./ -s init.s -s setup_page_tables.s -s trap_handlers.s -s add.s -c ${MAIN}.c -N ${MAIN} -L LinkerScript.lnk  -D AJIT -U
