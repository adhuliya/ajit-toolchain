...
def setGlobals(ajit_project_home, ajitcc):
	...
	SPARC_CC_FLAGS =  " -S -Wall -Werror -m32 -mcpu=v8 -nostdlib -ffreestanding -ffunction-sections"
	...
	SPARC_LD_FLAGS =" -e main -static --gc-sections -T "  #AD modified added -L...
...
def buildExecutable(work_area, link_sections, obj_files, linker_script_file, elf_file, hex_dump_file,variable_dump_file,memmap_file, objdump_file):
    ...
    sparc_ld_command += " -L/home/codeman/.itsoflife/local/packages-live/sparc-glibc-2-21_second/install/lib -L/home/zeal/AjitRepoV2_cpy/tools/cross-compiler/release/lib/gcc/sparc-elf/4.4.3/ -lm -lc -lgcc "
