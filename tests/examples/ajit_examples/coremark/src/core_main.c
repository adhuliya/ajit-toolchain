...
#if MAIN_HAS_NOARGC
MAIN_RETURN_TYPE ajit_main(void) {
#else
MAIN_RETURN_TYPE ajit_main(int argc, char *argv[]) {
	...
	ee_printf("CORE_DEBUG=1, seed1 = %lu!\n", results[0].seed1);
	ee_printf("CORE_DEBUG=1, seed2 = %lu!\n", results[0].seed2);
	ee_printf("CORE_DEBUG=1, seed3 = %lu!\n", results[0].seed3);
	ee_printf("CORE_DEBUG=1, iterations = %lu!\n", results[0].iterations);
#endif
