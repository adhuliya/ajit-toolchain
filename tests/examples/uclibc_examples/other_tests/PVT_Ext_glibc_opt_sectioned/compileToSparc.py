...
def buildExecutable(work_area, link_sections, obj_files, linker_script_file, elf_file, hex_dump_file,variable_dump_file,memmap_file, objdump_file, glibc_version):
    ...
    if (glibc_version != ""):
      BUILDROOT_LIBS = "/home/anshuman/buildroot-2014.08/output/host/usr/sparc-buildroot-linux-uclibc/sysroot/usr/lib"
      BUILDROOT_LIBGCC = "/home/anshuman/buildroot-2014.08/output/build/host-gcc-final-4.7.4/build/sparc-buildroot-linux-uclibc/libgcc" 
