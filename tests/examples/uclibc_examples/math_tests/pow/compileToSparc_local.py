...
def setGlobals(ajit_project_home, ajitcc):
	...
	global SPARC_CC_OPT_FLAGS 
        SPARC_CC_OPT_FLAGS = " -ffreestanding -fschedule--fdata-sections -ffunction-sections insns -fschedule-insns2 -frename-registers "
	...
	SPARC_LD_FLAGS =" -e main -L/home/codeman/.itsoflife/local/packages-live/sparc-glibc-2-21/install/lib -L/home/zeal/AjitRepoV2_cpy/tools/cross-compiler/release/lib/gcc/sparc-elf/4.4.3/ -static -lm -lc -lgcc -T "  #AD modified added -L...
...
def buildExecutable(work_area, link_sections, obj_files, linker_script_file, elf_file, hex_dump_file,variable_dump_file,memmap_file, objdump_file):
    ...
    sparc_ld_command = SPARC_LD+SPARC_LD_FLAGS+ linker_script_file  + obj_file_string
    sparc_ld_command += " -L/home/codeman/.itsoflife/local/packages-live/sparc-glibc-2.21/install/lib -L/home/zeal/AjitRepoV2/tools/cross-compiler/release/lib/gcc/sparc-elf/4.4.3/ -static -lm -lc -lgcc "
...
def parseOptions(opts):
    ...
    return help_flag, work_area, linker_script_file, elf_file, hex_file, var_file, mmap_file, objdump_file, assembly_dirs, assembly_files,  src_dirs, src_files, include_dirs, define_strings , debug_mode, opt_level, link_sections
...
def main():
    ...
    arg_list = sys.argv[1:]
    opts,args = getopt.getopt(arg_list,'W:L:C:c:S:s:I:D:E:H:V:M:O:hgo:T:')
    help_flag, work_area, linker_script_file, elf_file, hex_file, var_file, mmap_file, objdump_file, assembly_dirs, assembly_files,  src_dirs, src_files, include_dirs, define_strings, debug_mode, opt_level,link_sections  = parseOptions(opts)
