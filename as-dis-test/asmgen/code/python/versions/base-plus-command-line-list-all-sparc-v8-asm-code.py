...
def do_given (bitfld, insn, is_arg_num):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Doing GIVEN", l=bitfld))
    out_lst = []
    out_opc_lst = []
    reg_val_lst = []
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Doing GIVEN", l=out_lst))
...
def do_lookup (bitfld, insn, is_arg_num):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Doing LOOKUP", l=bitfld))
    out_lst = []
    out_opc_lst = []
    reg_val_lst = []
    ...
    theval = useval
    useval = (useval << bf_end)
    # print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l:032b} ({d})".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="LOOKUP val", l=theval, d=theval))
    # print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l:032b} ({d})".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="LOOKUP useval", l=useval, d=useval))

    out_opc_lst = [useval]
    out_lst = [is_arg_num, bf_name, bf_val_type, out_opc_lst, reg_val_lst, theval]
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Doing LOOKUP", l=out_lst))
...
def do_generate (bitfld, insn, is_arg_num):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Doing GENERATE", l=bitfld))
    out_lst = []
    out_opc_lst = []
    reg_val_lst = []
    ...
    if (bf_nbits <= max_list_length_bits):
        ...
        # print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:16s}: {l} values".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Generating", l=num_vals))
    ...
    out_lst = [is_arg_num, bf_name, bf_val_type, out_opc_lst, reg_val_lst, theval]
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Doing GENERATE", l=out_lst))
...
def do_range (bitfld, insn, is_arg_num):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Doing RANGE", l=bitfld))
    out_lst = []
    out_opc_lst = []
    reg_val_lst = []
    ...
    out_lst = [is_arg_num, bf_name, bf_val_type, out_opc_lst, reg_val_lst, theval]
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Doing RANGE", l=out_lst))
...
def expand_bit_field (bitfld, insn):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Expanding BIT FLD", l=bitfld))
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Bit Field Expanded to", l=bitlst))
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Expanding Bit Field", l=bitfld))
...
def expand_insn (insn):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}Expanding insn: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), l=insn))
    # pp.pprint (insn)
    # print (insn)
    print ("=== {c:02d}/{mi:02d} {p:{w}s}   {m:20s}: {n}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="INSN name", n=insn[insn_name_at]))

    expanded_outlst = []
    print ("=== {c:02d}/{mi:02d} {p:{w}s}   {m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Using format", l=insn [insn_fmt_index_at][0][0]))
            
    fmt_iterator = iter (insn [insn_fmt_index_at])

    for fmt in fmt_iterator:
        print ("=== {c:02d}/{mi:02d} {p:{w}s}   {m:20s}: {n}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="FMT name", n=fmt [fmt_name_at]))
        ...
        for bitfld in bit_fields_iterator:
            ...
            print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Appending bitfield", l=thlst))
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Expanded insn", l=insn[insn_fmt_index_at]))

    do_final_expansion (insn)
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Expanding insn", l=insn))
...
def do_final_expansion (insn):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {d}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="#OC Lists:", d=len(oclst)))
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="OC Lists:", l=oclst))
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {d}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="#Info Lists:", d=len(infolst)))
    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}: {l}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="Info Lists:", l=infolst))
    build_list_of_opcodes (insn, oclst, infolst, [], 0)

    print ("=== {c:02d}/{mi:02d} {p:{w}s}{m:20s}".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent), m="DONE Final INSN Expansion"))
...
def expand_all_insns (il):
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}Expander started".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent)))
    ...
    print ("=== {c:02d}/{mi:02d} {p:{w}s}DONE Expander".format(c=call_depth, mi=maxindent, p=".", w=(3*maxindent)))
