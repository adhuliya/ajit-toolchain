...
UTILDIR=../../../util
SRCDIR=../../../src
SRCS=" -c $UTILDIR/example-codelock.c -c $SRCDIR/ajit_timer.c  -C $AAR/src -s ../init.s -s $AAR/asm/trap_handlers.s -C $PT/src "
INCLUDES="-I /usr/include/x86_64-linux-gnu/gnu -I ../../../include -I $AAR/include -I $PT/include"
# Keep clock frequency at 256 for C model run.
DEFS="-D AJIT_CLOCK_FREQUENCY=256 -D HAS_FLOAT -D AJIT"
#DEFS="-D AJIT_CLOCK_FREQUENCY=100000000 -D HAS_FLOAT -D AJIT -D NDEBUG"
#
