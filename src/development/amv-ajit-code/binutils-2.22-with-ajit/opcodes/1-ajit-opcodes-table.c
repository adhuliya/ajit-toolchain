...
/* { "cswapd",     F9(3, 0x2f, 0x0), F9(~3, ~0x2f, ~0x0), "[1+2]A,d", 0, ajit }, /\* AJIT *\/ */
/* { "cswapd",     F9(3, 0x2f, 0x1), F9(~3, ~0x2f, ~0x1), "[1+i],d",  0, ajit }, /\* AJIT *\/ */
/* { "cswapda",    F9(3, 0x3f, 0x0), F9(~3, ~0x3f, ~0x0), "[1+2]A,d", 0, ajit }, /\* AJIT *\/ */
/* { "cswapda",    F9(3, 0x3f, 0x1), F9(~3, ~0x3f, ~0x1), "[1+i],d",  0, ajit }, /\* AJIT *\/ */

/* { "cswapd",     F3(3, 0x2f, 0x0), F3(~3, ~0x2f, ~0x0), "[1+2]A,d", 0, ajit }, /\* AJIT *\/ */
/* { "cswapd",     F3(3, 0x2f, 0x1), F3(~3, ~0x2f, ~0x1), "[1+i],d",  0, ajit }, /\* AJIT *\/ */
/* { "cswapda",    F3(3, 0x3f, 0x0), F3(~3, ~0x3f, ~0x0), "[1+2]A,d", 0, ajit }, /\* AJIT *\/ */
/* { "cswapda",    F3(3, 0x3f, 0x1), F3(~3, ~0x3f, ~0x1), "[1+i],d",  0, ajit }, /\* AJIT *\/ */
