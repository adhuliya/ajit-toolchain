...
/* The AJIT opcode table (and other related data) is defined in
   the opcodes library in ajit-opc.c.  If you change anything here, make
...
/* List of instruction sets variations.
   ...
   preceding each one or they conflict in which case AJIT_OPCODE_CONFLICT_P
   returns non-zero.
   The values are indices into `ajit_opcode_archs' defined in ajit-opc.c.
   Don't change this without updating ajit-opc.c.  */
...
/* All ajit opcodes are 32 bits, except for the `set' instruction (really a
