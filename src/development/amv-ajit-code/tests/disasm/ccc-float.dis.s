...
00000000 <main>:
   ...
   4:	8d a0 a8 64 	vfadd16  %f2, %f4, %f6
   8:	8d a0 a8 a4 	vfsub16  %f2, %f4, %f6
   c:	8d a0 a8 e4 	vfmul16  %f2, %f4, %f6
  10:	8d a0 a8 44 	vfadd32  %f2, %f4, %f6
  14:	8d a0 a8 84 	vfsub32  %f2, %f4, %f6
  18:	8d a0 a8 c4 	vfmul32  %f2, %f4, %f6
  1c:	89 a0 aa 00 	faddreduce16  %f2, %f4
  20:	87 a0 6a 20 	fstoh  %f1, %f3
  24:	87 a0 6a 40 	fhtos  %f1, %f3
  28:	82 80 40 22 	adddcc  %g1, %g2, %g1
  2c:	82 20 40 22 	subd  %g1, %g2, %g1
  30:	82 a0 40 22 	subdcc  %g1, %g2, %g1
