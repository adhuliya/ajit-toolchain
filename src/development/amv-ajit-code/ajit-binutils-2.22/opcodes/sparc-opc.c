...
{ "vfi16toh",     F3F(2, 0x34, 0x148), F3F(~2, ~0x34, ~0x148), "B,H", F_FLOAT, v8}, /* rs1,rs2,rd are even numbered! */ /* AJIT */
{ "vfhtoi16",     F3F(2, 0x34, 0x149), F3F(~2, ~0x34, ~0x149), "B,H", F_FLOAT, v8}, /* rs1,rs2,rd are even numbered! */ /* AJIT */
{ "faddreduce16", F3F(2, 0x34, 0x150), F3F(~2, ~0x34, ~0x150), "B,g", F_FLOAT, v8}, /* rs1,rs2,rd are even numbered! */ /* AJIT */
{ "fstoh",        F3F(2, 0x34, 0x151), F3F(~2, ~0x34, ~0x151), "f,g", F_FLOAT, v8}, /* rs1,rs2,rd are even numbered! */ /* AJIT */
{ "fhtos",        F3F(2, 0x34, 0x152), F3F(~2, ~0x34, ~0x152), "f,g", F_FLOAT, v8}, /* rs1,rs2,rd are even numbered! */ /* AJIT */
