...
00000000 <.rodata>:
   0:	4c 69 73 74 	call  31a5cdd0 <llrec+0x31a5caa4>
   4:	20 61 73 20 	unknown
   8:	25 64 20 6d 	unknown
   c:	65 6d 62 65 	call  95b589a0 <llrec+0x95b58674>
  10:	72 73 2e 0a 	call  c9ccb838 <llrec+0xc9ccb50c>
  14:	00 00 00 00 	unimp  0
  18:	45 6c 65 6d 	call  15b195cc <llrec+0x15b192a0>
  1c:	65 6e 74 20 	call  95b9d09c <llrec+0x95b9cd70>
  20:	25 30 32 64 	sethi  %hi(0xc0c99000), %l2
  24:	20 3a 20 25 	unknown
  28:	64 0a 00 00 	call  90280028 <llrec+0x9027fcfc>
  2c:	00 00 00 00 	unimp  0

Disassembly of section .comment:

00000000 <.comment>:
   0:	00 47 43 43 	unknown
   4:	3a 20 28 42 	unknown
   8:	75 69 6c 64 	call  d5a5b198 <llrec+0xd5a5ae6c>
   c:	72 6f 6f 74 	call  c9bdbddc <llrec+0xc9bdbab0>
  10:	20 32 30 31 	unknown
  14:	34 2e 30 38 	unknown
  18:	29 20 34 2e 	sethi  %hi(0x80d0b800), %l4
  1c:	37 2e 34 00 	sethi  %hi(0xb8d00000), %i3
