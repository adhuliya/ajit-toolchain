! Test for checking "sll instruction"
...
_start:
	...
	! Shift by 1
	sethi %hi(0x80000001),%g2
	or    %g2,%lo(0x80000001),%g2
	mov 0x01,%g3
	rd %psr, %i0
	sll %g2,%g3,%l1 				! l1 = 0x00000002
	rd %psr, %i1

	! Shift by 2
	! note only bottom 5 bits to be used
	! as shift amount..  Top 27 bits ignored.
	!
	mov 0xffffff02,%g3
	sll %l1,%g3,%l2  				! l2 = 0x00000008
	rd %psr, %i2


	! Shift by 0
	mov 0x00,%g3
	sll %l2,%g3,%l3  				! l3 = 0x00000008
	rd %psr, %i3
	...
	!
	mov 0x1, %g7
	sll %g7,0x10,%l4  				! l4 = 0x00020000

	! Shift by 31
	!
	sll %g7,0x1f,%l5  				! l5 = 0x80000000
