...
_start:
	...
	set 0x3, %l2
	set 0x3, %l3
	addd %l0, %l2, %o0	! Expected o0,o1=0x00000005
	rd %psr, %i4		! Expected i3=0xE0
	...
	set 0xffffffff, %l2
	set -2, %l3
	addd %l0, %l2, %o2	! Expected o2,o3=0xFFFFFFFC
	rd %psr, %i5		! Expected i4=0xE0
	...
	set  3, %l3
	set  0, %l2
	addd %l0, %l2, %o4	! Expected o4=0, o5=1
	...
	set  1, %l3
	set  0, %l2
	addd %l0, %l2, %o6	! Expected o6=0xFFFFFFFF, o7 =0xffffffff
	...
	set 0x77ffffff, %l2
	set 0xffffffff, %l3
	addd %l0, %l2, %i0	! Expected i0=0xEFFFFFFF, i1=0xfffffffe
	...
	set 0xffffffff, %l2
	set 0xfffffffe, %l3
	addd %l0, %l2, %i2	! Expected i2=0xffffffff, i3 =oxffffffffc
