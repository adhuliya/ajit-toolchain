...
start:
	...
	! Perform instruction test and store 
        ...
        set 0xf000d2fa, %g4
        set 0xf000d2fa, %g5
       	vaddd8 %g2,%g4,%o0	 !o0 and o1 = e00898f2
        vaddd16 %g2,%g4,%o2	 !o2 ans o3 = e00899f2
       	vaddd32 %g2,%g4,%o4	 !o4 and o5 = e00999f2 
        ...
        set 0x50505050, %g4
        set 0x50505050, %g5
        vsubd8 %g2,%g4,%o6	!All outputs = 0x50505050
        vsubd16 %g2,%g4,%l0
        vsubd32 %g2,%g4,%l2
        ...
        set 0x01010101, %g5
        set 0x01010101, %g4
        vumuld8 %g2,%g4,%l4	! l4 and l5 = 02020202
        vumuld16 %g2,%g4,%l6	! l6 and l7 = 04020402
        vumuld32 %g2,%g4,%i0	! i0 and i1 = 08060402
        ...
        set 0xfffffffe, %g5
        set 0xfffffffe, %g4
        vsmuld8 %g2,%g4,%i2	!i2=fa i3=fdfdfdfa
        vsmuld16 %g2,%g4,%i4	!i4=fa i5=fcfdf9fa
        vsmuld32 %g2,%g4,%i6	!i6=fa i7=f9f9f9fa
