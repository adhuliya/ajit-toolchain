! Test for checking 'umul instruction'
!
...
_start:
	...
	! Multiply 2 small numbers 
	rd %psr, %i0	
	set 0x00,%g2 
	set 0x03,%g3 
	set 0x00,%g4 
	set 0x02,%g5 
	umuld %g2,%g4,%l0 				! Result of multiplication is 0x06 
	rd %psr, %i1

	! Multiply a small and a large number (negetive in signed notation)
	set 0x00,%g2
	set 0x03,%g3 
	set 0xffffffff,%g4
	set 0xFFFFFFFE,%g5				
	umuld %g4,%g2,%l2 				! Result of multiplication is 0x02FFFFFFFA 
	rd %psr, %i2

	! Multiply 2 large numbers (negetive in signed notation)
	set 0x80000000,%g2 
	set 0x00000000,%g3 	
	set 0x80000000,%g6
	set 0x00000000,%g7				
	umuld %g6,%g2,%l4 				! Result of multiplication is 0x4000000000000000
	rd %psr, %i3
...
sethi %hi(0x33333333),%l0
or    %l0,%lo(0x33333333),%l0
sethi %hi(0x00000005),%l1
or    %l1,%lo(0x00000005),%l1
umul %l0,%l1,%l2 !%l2 should contain 0xFFFFFFFF
rd %y, %i3	!%i3 should have 0x00000000
rd %psr, %i4


sethi %hi(0xFFFFFFFF),%l0
or    %l0,%lo(0xFFFFFFFF),%l0
sethi %hi(0x00000002),%l1
or    %l1,%lo(0x00000002),%l1
umul %l0,%l1,%l3 !%l3 should contain 0xfffffffe
rd %y, %i5	!%i5 should have 0x00000001
rd %psr, %i6
