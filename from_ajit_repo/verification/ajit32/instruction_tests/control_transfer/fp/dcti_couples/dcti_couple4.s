...
! first branch is taken, second branch is FBA, a=1 (annulled)	
...
_start:
	...
	fba label1	! unconditional branch that should have been taken
			! but is not taken because of fba,a
	fba,a label2	! unconditional branch, annulled

	mov 0xF00, %g3	! delay slot instruction is never executed 

label1:			! control doesnt reach this address
	add %o1, 0x3, %o0
	mov 0x88, %g4


label2:				! control directly jumps here	 
	add %o0, 0x3, %o1	! Expected o1=0x00000004
