...
_start:
	...
	!Initialize o0. Upon a trap, g1 should be 
	...
	! instruction = CALL
		...
		set pc1, %g2
pc1	:	call pc2	
n_pc1 	:	mov 0xABC, %o0	! delay slot instruction is executed in the same window
		ta 0			
		nop
		nop
		nop
		mov 0xDEF, %g3	! control doesn't reach here


pc2	:	mov %r15, %g4	! g4=g2
		save
		ret
		restore
		nop
