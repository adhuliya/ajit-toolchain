/*----------------------------------------------------------------------------
Filename:			page_error_AT1_S7.c
Version:			1.00
Goal: 				Fault Type=1 for Acess Type=1 and PTE.V=0
...
4.	In context 0 read data using virtual addr(0x20000000) and load it in g7 register.
...
//--------------------------------setting page table---------------------------------------------------
	...
	for(i=0x00; i<=0x10; i++)
	{
	//PTE fields : USER ASI:(Instruction=0x8,Data=0xA) SUPER ASI:(Instruction=0x9,Data=0xB)
	// C M R ACC ET
