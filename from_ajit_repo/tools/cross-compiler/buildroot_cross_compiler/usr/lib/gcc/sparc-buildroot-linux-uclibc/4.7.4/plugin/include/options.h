...
#define MASK_FLAT (1 << 3)
#define MASK_FMAF (1 << 4)
#define MASK_FPU (1 << 5)
#define MASK_HARD_QUAD (1 << 6)
#define MASK_POPC (1 << 7)
#define MASK_PTR64 (1 << 8)
#define MASK_STACK_BIAS (1 << 9)
#define MASK_UNALIGNED_DOUBLES (1 << 10)
#define MASK_V8PLUS (1 << 11)
#define MASK_VIS (1 << 12)
#define MASK_VIS2 (1 << 13)
#define MASK_VIS3 (1 << 14)
#define MASK_DEPRECATED_V8_INSNS (1 << 15)
#define MASK_LONG_DOUBLE_128 (1 << 16)
#define MASK_SPARCLET (1 << 17)
#define MASK_SPARCLITE (1 << 18)
#define MASK_V8 (1 << 19)
#define MASK_V9 (1 << 20)
...
enum opt_code
{
  ...
  OPT_mapp_regs = 989,                       /* -mapp-regs */
  OPT_mbionic = 990,                         /* -mbionic */
  OPT_mcmodel_ = 991,                        /* -mcmodel= */
  OPT_mcpu_ = 992,                           /* -mcpu= */
  OPT_mdebug_ = 993,                         /* -mdebug= */
  OPT_mfaster_structs = 994,                 /* -mfaster-structs */
  OPT_mfix_at697f = 995,                     /* -mfix-at697f */
  OPT_mflat = 996,                           /* -mflat */
  OPT_mfmaf = 997,                           /* -mfmaf */
  OPT_mfpu = 998,                            /* -mfpu */
  OPT_mglibc = 999,                          /* -mglibc */
  OPT_mhard_float = 1000,                    /* -mhard-float */
  OPT_mhard_quad_float = 1001,               /* -mhard-quad-float */
  OPT_mlong_double_128 = 1002,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1003,                /* -mlong-double-64 */
  OPT_mmemory_model_ = 1004,                 /* -mmemory-model= */
  OPT_mmusl = 1005,                          /* -mmusl */
  OPT_mpopc = 1006,                          /* -mpopc */
  OPT_mptr32 = 1007,                         /* -mptr32 */
  OPT_mptr64 = 1008,                         /* -mptr64 */
  OPT_mrelax = 1009,                         /* -mrelax */
  OPT_msoft_float = 1010,                    /* -msoft-float */
  OPT_msoft_quad_float = 1011,               /* -msoft-quad-float */
  OPT_mstack_bias = 1012,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1013,             /* -mstd-struct-return */
  OPT_mtune_ = 1014,                         /* -mtune= */
  OPT_muclibc = 1015,                        /* -muclibc */
  OPT_munaligned_doubles = 1016,             /* -munaligned-doubles */
  OPT_mv8plus = 1017,                        /* -mv8plus */
  OPT_mvis = 1018,                           /* -mvis */
  OPT_mvis2 = 1019,                          /* -mvis2 */
  OPT_mvis3 = 1020,                          /* -mvis3 */
  OPT_n = 1021,                              /* -n */
  OPT_no_canonical_prefixes = 1022,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1023,              /* -no-integrated-cpp */
  OPT_nocpp = 1024,                          /* -nocpp */
  OPT_nodefaultlibs = 1025,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1026,                   /* -nostartfiles */
  OPT_nostdinc = 1027,                       /* -nostdinc */
  OPT_nostdinc__ = 1028,                     /* -nostdinc++ */
  OPT_nostdlib = 1029,                       /* -nostdlib */
  OPT_o = 1030,                              /* -o */
  OPT_p = 1031,                              /* -p */
  OPT_pass_exit_codes = 1032,                /* -pass-exit-codes */
  OPT_pedantic = 1033,                       /* -pedantic */
  OPT_pedantic_errors = 1034,                /* -pedantic-errors */
  OPT_pg = 1035,                             /* -pg */
  OPT_pie = 1036,                            /* -pie */
  OPT_pipe = 1037,                           /* -pipe */
  OPT_posix = 1038,                          /* -posix */
  OPT_print_file_name_ = 1039,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1040,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1041,          /* -print-multi-directory */
  OPT_print_multi_lib = 1042,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1043,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1044,                /* -print-multiarch */
  ...
  OPT_std_f2008ts = 1082,                    /* -std=f2008ts */
  ...
  OPT_std_gnu11 = 1089,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1090, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1091, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1092,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1093,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1094, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1095, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1096,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1097, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1098, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1099, */         /* -std=iso9899:2011 */
