...
Standalone Model that emulates an SD card,
compliant with SDHC version 3.0.

Device Registers:
SD card registers are defined in sd.h
*/
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
...
#ifdef DEBUG    
    fprintf(stderr,"data written in SDCARD_to_SDHC pipe 0x%x\r\n",SDCARD_INSERT);
#endif
}
...
//in this case, the sdcard standalone testbench
...
void sdCardControl()
{
    ...
    while(1)
    {
        ...
        pthread_mutex_unlock(&SDcard_lock);
    }
}
