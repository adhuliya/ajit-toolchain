...
{
	uint32_t argument2; 			//0x00	index[0]
	...
	uint16_t response2; 			//0x14 	index[8]
	uint16_t response3; 			//0x18 	index[9]
	uint16_t response4; 			//0x1c 	index[10]
	uint16_t response5; 			//0x10	index[11]
...
{
	uint8_t argument2[4];			//0x00	index[0]
	uint8_t blk_size[2]; 			//0x4	index[1]
	uint8_t blk_count[2]; 			//0x6	index[2]
	uint8_t argument[4]; 			//0x8	index[3]
	uint8_t tx_mode[2]; 			//0xC	index[4]
	uint8_t command_reg[2]; 		//0x	index[5]
	uint8_t response0[2]; 			//0x1	index[6]
	uint8_t response1[2]; 			//0x1	index[7]
	uint8_t response2[2]; 			//0x14	index[8]
	uint8_t response3[2]; 			//0x18	index[9]
	uint8_t response4[2]; 			//0x1c	index[10]
	uint8_t response5[2]; 			//0x1	index[11]
