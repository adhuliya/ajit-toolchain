...
.align 8
!
! buffer is used to store state of
! interrupted job (from trap window T)
!
generic_isr_ibuffer:
.skip 256
!
! This flag ensures that an error condition is reached
! if there is an interrupt on top of an interrupt.
!   (like an ASSERT ERROR)
!
