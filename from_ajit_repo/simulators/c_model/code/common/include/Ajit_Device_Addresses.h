...
#define ADDR_SDHC_POWER_CONTROL                 0xFFFF3328      // 1 BYTES WIDE
#define ADDR_SDHC_HOST_CONTROL_1                0xFFFF3329      // 1 BYTES WIDE
#define ADDR_SDHC_WAKEUP_CONTROL                0xFFFF332A      // 1 BYTES WIDE
#define ADDR_SDHC_BLOCK_GAP_CONTROL             0xFFFF332B      // 1 BYTES WIDE
#define ADDR_SDHC_CLOCK_CONTROL                 0xFFFF332C      // 2 BYTES WIDE
#define ADDR_SDHC_SOFTWARE_RESET                0xFFFF332E      // 1 BYTES WIDE
#define ADDR_SDHC_TIMEOUT_CONTROL               0xFFFF332F      // 1 BYTES WIDE
...
#define ADDR_SDHC_FORCE_EVENT_AUTOCMD_ERRSTAT_R 0xFFFF3352      // 2 BYTES WIDE
#define ADDR_SDHC_ADMA_ERR_STAT                 0xFFFF3355      // 1 BYTE WIDE
