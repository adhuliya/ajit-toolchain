...
00000000 <main>:
   ...
   8:	a5 28 80 84 	slld  %g2, %g4, %l2
   c:	a5 28 a0 82 	slld  %g2, 2, %l2
  10:	8d 30 80 84 	srld  %g2, %g4, %g6
  14:	8d 30 a0 82 	srld  %g2, 2, %g6
  18:	a1 38 80 84 	srad  %g2, %g4, %l0
  1c:	a1 38 a0 82 	srad  %g2, 2, %l0
