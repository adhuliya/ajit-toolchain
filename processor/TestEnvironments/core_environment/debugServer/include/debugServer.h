...
typedef enum __DebugServerCoreMode {
	dbg_SINGLE_CORE_MODE,
	dbg_MULTI_CORE_MODE
} DebugServerCoreMode;
...
typedef struct __perCoreDebugServerState {
...
void initPerCoreDebugServerState(int core_id);
...
void perCoreSendU32FromDebugServerToCcu(int CORE_ID, DebugServerConnectMode cmode, uint32_t word);

void recvU32FromCcuToDebugServer(DebugServerConnectMode DebugServerConnectMode, uint32_t *word);
void perCoreRecvU32FromCcuToDebugServer(int CORE_ID, DebugServerConnectMode DebugServerConnectMode, uint32_t *word);
...
void stopPerCoreNoblockDaemon (int CPUID);

// for multi-core sims.
void startPerCoreDebugServerDaemons (int ncores);
